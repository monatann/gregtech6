...
public class LoaderOreDictReRegistrations implements Runnable {
	...
	public void run() {
		...
		OreDictManager.INSTANCE.setAutomaticItemData("itemLeather", new OreDictItemData(MT.Leather, 1*U));
		...
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.GraniteBlack   ), new OreDictItemData(MT.GraniteBlack  , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.GraniteRed     ), new OreDictItemData(MT.GraniteRed    , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Granite        ), new OreDictItemData(MT.Granite       , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Flint          ), new OreDictItemData(MT.Flint         , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Concrete       ), new OreDictItemData(MT.Concrete      , U));
		...
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Basalt         ), new OreDictItemData(MT.Basalt        , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Marble         ), new OreDictItemData(MT.Marble        , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Quartzite      ), new OreDictItemData(MT.Quartzite     , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Limestone      ), new OreDictItemData(MT.Limestone     , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.CaCO3          ), new OreDictItemData(MT.CaCO3         , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Rhyolite       ), new OreDictItemData(MT.Rhyolite      , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Andesite       ), new OreDictItemData(MT.Andesite      , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Gabbro         ), new OreDictItemData(MT.Gabbro        , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Komatiite      ), new OreDictItemData(MT.Komatiite     , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Dacite         ), new OreDictItemData(MT.Dacite        , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Gneiss         ), new OreDictItemData(MT.Gneiss        , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Blueschist     ), new OreDictItemData(MT.Blueschist    , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Greenschist    ), new OreDictItemData(MT.Greenschist   , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Soapstone      ), new OreDictItemData(MT.Soapstone     , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Migmatite      ), new OreDictItemData(MT.Migmatite     , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Chalk          ), new OreDictItemData(MT.Chalk         , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Siltstone      ), new OreDictItemData(MT.Siltstone     , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Lignite        ), new OreDictItemData(MT.Lignite       , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Greywacke      ), new OreDictItemData(MT.Greywacke     , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Chert          ), new OreDictItemData(MT.Chert         , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Diorite        ), new OreDictItemData(MT.Diorite       , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.MoonRock       ), new OreDictItemData(MT.MoonRock      , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.MoonTurf       ), new OreDictItemData(MT.MoonTurf      , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.MarsRock       ), new OreDictItemData(MT.MarsRock      , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.MarsSand       ), new OreDictItemData(MT.MarsSand      , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.SpaceRock      ), new OreDictItemData(MT.SpaceRock     , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Umber          ), new OreDictItemData(MT.Umber         , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Betweenstone   ), new OreDictItemData(MT.Betweenstone  , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Pitstone       ), new OreDictItemData(MT.Pitstone      , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Kimberlite     ), new OreDictItemData(MT.Kimberlite    , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Livingrock     ), new OreDictItemData(MT.Livingrock    , U));
		OreDictManager.INSTANCE.setAutomaticItemData(OP.stone.dat(MT.Holystone      ), new OreDictItemData(MT.Holystone     , U));
	}
}
