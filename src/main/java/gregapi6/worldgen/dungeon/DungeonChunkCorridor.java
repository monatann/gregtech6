...
public class DungeonChunkCorridor extends DungeonChunkPillar {
	...
	public boolean generate(DungeonData aData) {
		...
		if (aData.mRoomLayout[aData.mRoomX+1][aData.mRoomZ] != 0) {
			...
			aData.set                              (10, 1, 8, SIDE_UNKNOWN, (short)((aData.mRandom.nextInt(2)==0?508:8)+aData.mRandom.nextInt(3)), UT.NBT.make("gt6.dungeonloot", ChestGenHooks.STRONGHOLD_CORRIDOR, NBT_FACING, SIDE_X_NEG), T, T);
			aData.smooth                      (10, 1, 9);
		...
		if (aData.mRoomLayout[aData.mRoomX-1][aData.mRoomZ] != 0) {
			...
			aData.smooth                      (5, 1, 6);
			aData.set                              (5, 1, 7, SIDE_UNKNOWN, (short)((aData.mRandom.nextInt(2)==0?508:8)+aData.mRandom.nextInt(3)), UT.NBT.make("gt6.dungeonloot", ChestGenHooks.STRONGHOLD_CORRIDOR, NBT_FACING, SIDE_X_POS), T, T);
		...
		if (aData.mRoomLayout[aData.mRoomX][aData.mRoomZ+1] != 0) {
			...
			aData.set                              (8, 1, 10, SIDE_UNKNOWN, (short)((aData.mRandom.nextInt(2)==0?508:8)+aData.mRandom.nextInt(3)), UT.NBT.make("gt6.dungeonloot", ChestGenHooks.STRONGHOLD_CORRIDOR, NBT_FACING, SIDE_Z_NEG), T, T);
			aData.smooth                      (9, 1, 10);
		...
		if (aData.mRoomLayout[aData.mRoomX][aData.mRoomZ-1] != 0) {
			...
			aData.smooth                      (6, 1, 5);
			aData.set                              (7, 1, 5, SIDE_UNKNOWN, (short)((aData.mRandom.nextInt(2)==0?508:8)+aData.mRandom.nextInt(3)), UT.NBT.make("gt6.dungeonloot", ChestGenHooks.STRONGHOLD_CORRIDOR, NBT_FACING, SIDE_Z_POS), T, T);
