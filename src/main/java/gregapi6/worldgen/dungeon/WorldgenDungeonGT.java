...
public class WorldgenDungeonGT extends WorldgenObject {
	...
	public static final TagData
	  TAG_PORTAL_NETHER   = TagData.createTagData("gt6.dungeon.portal.nether")
	, TAG_PORTAL_END      = TagData.createTagData("gt6.dungeon.portal.end")
	, TAG_PORTAL_TWILIGHT = TagData.createTagData("gt6.dungeon.portal.twilight")
	, TAG_PORTAL_MYST     = TagData.createTagData("gt6.dungeon.portal.myst")
	;
	...
	public static boolean setCoins(World aWorld, int aX, int aY, int aZ, DungeonData aData, Random aRandom) {
		for (int i = 0; i < 16; i++) aData.mCoin.setByte("gt6.coin.stacksize."+i, (byte)(aRandom.nextInt(3) == 0 ? aRandom.nextInt(8) : 0));
		aData.mCoin.setByte("gt6.coin.stacksize."+aRandom.nextInt(16), (byte)(1+aRandom.nextInt(8)));
