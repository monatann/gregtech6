 ...
 */
public class CoverControllerRedstone extends AbstractCoverAttachmentController {
	@Override
	...
	public boolean getStateOnOff(byte aSide, CoverData aData) {
		return UT.Code.bind1(aData.mTileEntity.getRedstoneIncoming(aSide)) != (aData.mValues[aSide] & B[0]);
	}
}
