...
public class TriggerBC_Energy_Capacity_NotFull extends TriggerBC {
	...
	public TriggerBC_Energy_Capacity_NotFull(TagData aEnergyType) {
		super(MD.GAPI.mID, aEnergyType.mName.toLowerCase()+".capacity.notfull", "Is Not Full (" + aEnergyType.getLocalisedNameShort() + ")");
