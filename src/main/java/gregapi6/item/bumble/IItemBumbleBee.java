...
public interface IItemBumbleBee {
	...
	public static class Util {
		public static NBTTagCompound getBumbleTag(ItemStack aBumbleBee) {
			NBTTagCompound aNBT = UT.NBT.getOrCreate(aBumbleBee), rBumbleTag = aNBT.getCompoundTag("gt6.bumble");
			aNBT.setTag("gt6.bumble", rBumbleTag);
			return rBumbleTag;
		}
		
		public static ItemStack setBumbleTag(ItemStack aBumbleBee, NBTTagCompound aBumbleTag) {
			UT.NBT.getOrCreate(aBumbleBee).setTag("gt6.bumble", aBumbleTag);
			return aBumbleBee;
		}
