...
public abstract class MultiItem extends ItemBase implements IItemEnergy {
	 ...
	 * @param aUnlocalized The Unlocalized Name of this Item. DO NOT START YOUR UNLOCALISED NAME WITH "gt6."!!!
	...
	public FluidStack getFluidContent(ItemStack aStack) {
		...
		return FL.load(aStack.getTagCompound(), "gt6.fluidcontent");
	}
	
	public void setFluidContent(ItemStack aStack, FluidStack aFluid) {
		NBTTagCompound tNBT = aStack.getTagCompound();
		if (tNBT == null) tNBT = UT.NBT.make(); else tNBT.removeTag("gt6.fluidcontent");
		if (aFluid != null && aFluid.amount > 0) FL.save(tNBT, "gt6.fluidcontent", aFluid);
