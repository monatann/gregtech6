...
public abstract class MultiItemRandom extends MultiItem implements Runnable, squeek.applecore.api.food.IEdible, ISpecialElectricItem, IElectricItemManager, IItemElectric {
