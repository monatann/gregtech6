 ...
 */
public class PacketSyncDataShortAndIDsAndCovers extends PacketSyncDataShortAndIDs {
	public short mCoverIDs[], mCoverMetas[], mCoverVisuals[];
	
	public PacketSyncDataShortAndIDsAndCovers(int aDecoderType) {
		super(aDecoderType);
	}
	
	public PacketSyncDataShortAndIDsAndCovers(int aX, int aY, int aZ, short aID1, short aID2, short aData, CoverData aCoverData) {
		super(aX, aY, aZ, aID1, aID2, aData);
		mCoverIDs = aCoverData.mIDs;
		mCoverMetas = aCoverData.mMetas;
		mCoverVisuals = aCoverData.mVisuals;
	}
	public PacketSyncDataShortAndIDsAndCovers(ChunkCoordinates aCoords, short aID1, short aID2, short aData, CoverData aCoverData) {
	...
	private PacketSyncDataShortAndIDsAndCovers(int aX, int aY, int aZ, short aID1, short aID2, short aData, ByteArrayDataInput aCovers) {
		super(aX, aY, aZ, aID1, aID2, aData);
	...
	public PacketCoordinates decode2(int aX, int aY, int aZ, ByteArrayDataInput aData) {
		return new PacketSyncDataShortAndIDsAndCovers(aX, aY, aZ, aData.readShort(), aData.readShort(), aData.readShort(), aData);
	}
