...
public interface IPacket {
	 ...
	 * 
	 * A better example might be provided by {@link gregapi6.network.packets.PacketCoordinates} and {@link gregapi6.network.packets.data.PacketSyncDataShort}, because those ones are actually useful unlike this example.
	 */
