...
public class MT {
	...
	*/
	...
	Clay                    = dustelec      ( 8215, "Clay"                  , SET_ROUGH             , 200, 200, 220, 255).put(MORTAR)                                                                                                                                   .uumMcfg( 7, Li             , 1*U, Al2O3            , 2*U, SiO2             , 2*U, Na               , 2*U)                                                  .heat(2000),
	ClayBrown               = dustelec      ( 8276, "ClayBrown"             , SET_ROUGH             , 230, 140,  75, 255).put(MORTAR)                                                                                                                                   .uumMcfg( 7, Li             , 1*U, Al2O3            , 2*U, SiO2             , 2*U, K                , 2*U)                                                  .heat(2000).setLocal("Brown Clay"),
	...
	*/
	...
	Brass                   = alloymachine  ( 8620, "Brass"                                         , 255, 180,   0, 255).put(FURNACE, EXTRUDER_SIMPLE, MORTAR, MOLTEN).qual(2, 7.0, 96, 1)                                                                             .uumMcfg( 0, Cu             , 3*U, Zn               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1).alloyCentrifuge(1160, Cu.mBoilingPoint),
	...
	Bronze                  = alloymachine  ( 8610, "Bronze"                                        , 210, 130,  60, 255).put(RAILS, FURNACE, EXTRUDER_SIMPLE, MORTAR, MOLTEN).qual(3, 6.0,  192, 2)                                                                    .uumMcfg( 0, Cu             , 3*U, Sn               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1).alloyCentrifuge(Cu.mMeltingPoint, Cu.mBoilingPoint),
	...
	BismuthBronze           = alloymachine  ( 8612, "Bismuth Bronze"        , SET_DULL              , 100, 125, 125, 255).put(FURNACE, EXTRUDER_SIMPLE, MORTAR, MOLTEN).qual(3,  8.0,  256, 2)                                                                          .setMcfg( 0, Bi             , 1*U, Brass            , 4*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1).alloyCentrifuge(),
	...
	AnnealedCopper          = metalnd       ( 8640, "Annealed Copper"       , SET_SHINY             , 255, 120,  20, 255).put(MOLTEN, FURNACE, EXTRUDER_SIMPLE, MORTAR, WIRES, RAILS)                                                                                   .uumMcfg( 0, Cu             , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.PERMUTATIO, 1           ).setPulver(Cu      , U)                                                                                                                                                        .steal(Cu).alloyCentrifuge(2800, Cu.mBoilingPoint),
	...
	TinAlloy                = alloymachine  ( 8667, "Tin Alloy"                                     , 200, 200, 200, 255).put(MORTAR, MOLTEN, FURNACE, EXTRUDER_SIMPLE).qual(3,  6.5,    96,  2)                                                                        .uumMcfg( 0, Sn             , 1*U, WroughtIron      , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.FABRICO, 1).alloyCentrifuge(),
	BatteryAlloy            = alloy         ( 8668, "Battery Alloy"         , SET_DULL              , 156, 124, 160, 255).put(MORTAR, MOLTEN, FURNACE, EXTRUDER_SIMPLE)                                                                                                 .uumMcfg( 0, Pb             , 4*U, Sb               , 1*U)                                                                                                  .alloyCentrifuge(),
	...
	Signalum                = alloymachine  ( 8708, "Signalum"                                      , 255,  64,   0, 255).put(MOLTEN, FURNACE, EXTRUDER_SIMPLE)                                                                                                         .uumMcfg( 8, Cu             , 1*U, Ag               , 2*U, RedAlloy         , 5*U)                                                                          .aspects(TC.METALLUM, 3, TC.POTENTIA, 1).alloyCentrifuge(),
	Lumium                  = slloymachine  ( 8709, "Lumium"                                        , 255, 255,  80, 255).put(MOLTEN, FURNACE, EXTRUDER_SIMPLE, LIGHTING, GLOWING)                                                                                      .uumMcfg( 4, Sn             , 3*U, Ag               , 1*U, Glowstone        , 4*U)                                                                          .aspects(TC.METALLUM, 3, TC.LUX, 1).alloyCentrifuge(),
...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60, 255).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                      ,
	FakeOsmium              = alloy         ( 8719, "Osmium"                                        , 160, 160, 255, 255).put(G_INGOT_MACHINE_ORES, MOLTEN, FURNACE, EXTRUDER_SIMPLE).setLocal("'Osmium'").steal(Os).qual(2, 6.0, 256, 2)                               .uumMcfg( 0, Os             , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.MACHINA, 2),
	 ...
	 * */
	RhodiumPlatedPalladium                = alloymachine  ( 31000, "Rhodium-Plated Palladium"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER_SIMPLE).qual(3,  6.5,    96,  2)                                                                        .uumMcfg( 0, Pd             , 3*U, Rh      , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.FABRICO, 1).alloyCentrifuge(),
	BlackPlutonium                = alloymachine  ( 31001, "Black Plutonium"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER_SIMPLE).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorULV                = alloymachine  ( 31002, "Superconductor Base ULV"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER_SIMPLE).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorLV                = alloymachine  ( 31003, "Superconductor Base LV"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER_SIMPLE).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorMV                = alloymachine  ( 31004, "Superconductor Base MV"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER_SIMPLE).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorHV                = alloymachine  ( 31005, "Superconductor Base HV"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER_SIMPLE).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorEV                = alloymachine  ( 31006, "Superconductor Base EV"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER_SIMPLE).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorIV                = alloymachine  ( 31007, "Superconductor Base IV"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER_SIMPLE).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorLuV                = alloymachine  ( 31008, "Superconductor Base LuV"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER_SIMPLE).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorZPM                = alloymachine  ( 31009, "Superconductor Base ZPM"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER_SIMPLE).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorUV                = alloymachine  ( 31010, "Superconductor Base UV"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER_SIMPLE).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorPUV1                = alloymachine  ( 31011, "Superconductor Base PUV1"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER_SIMPLE).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorPUV2                = alloymachine  ( 31012, "Superconductor Base PUV2"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER_SIMPLE).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
