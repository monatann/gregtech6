...
public class MT {
	...
	Ta4HfC5                 = alloymachine  ( 8802, "Tantalum Hafnium Carbide"                      ,  32, 128,  32, 255)                                                                                                                                               .uumMcfg( 0, Ta             , 4*U, Hf               , 1*U, C                , 5*U)                                                                          .aspects(TC.METALLUM, 2, TC.GELUM, 2).qual(2).heat(4263).alloyCentrifuge(),
	...
	Manyullyn               = alloymachine  ( 8703, "Manyullyn"                                     , 175, 100, 175, 255).put(MOLTEN).qual(2, 2.0,   96,  1)                                                                                                            .setMcfg( 0, Co             , 1*U, Ardite           , 1*U)                                                                                                  .aspects(TC.STRONTIO, 2).alloyCentrifuge(),
			VibraniumSteel          = slloymachine  ( 8704, "Vibranium Steel"                               ,  40,  24,  50, 255).put(CENTRIFUGE, MAGNETIC_PASSIVE).qual(3,   50.0, 2048, 10)                                                                                   .uumMcfg( 0, Vb             , 1*U, Steel            , 3*U)                                                                                                  .aspects(TC.SENSUS, 1, TC.VITREUS, 1, TC.METALLUM, 1).alloyCentrifuge(),
			VibraniumSilver         = slloy         ( 8705, "Vibranium Silver"                              , 240, 240, 255, 255).put(CENTRIFUGE, ENDER_DRAGON_PROOF).qual(3,  100.0,  512,  9)                                                                                 .uumMcfg( 0, Vb             , 1*U, Ag               , 3*U)                                                                                                  .aspects(TC.SENSUS, 1, TC.VITREUS, 1, TC.LUCRUM, 1).alloyCentrifuge(),
			Vibramantium            = slloymachine  ( 8706, "Vibramantium"                                  , 250, 250, 250, 255).put(CENTRIFUGE, MAGNETIC_PASSIVE).qual(3, 1000.0, 5120, 15)                                                                                   .uumMcfg( 0, Vb             , 1*U, Ad               , 3*U)                                                                                                  .aspects(TC.SENSUS, 1, TC.VITREUS, 1, TC.PRAECANTIO, 1, TC.METALLUM, 1).alloyCentrifuge(),
