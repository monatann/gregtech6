...
public class MT {
	...
	static OreDictMaterial wax          (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return dust            (aID, aNameOreDict, SET_FOOD        , aR, aG, aB, aA).put(FOILS, PLATES, INGOTS, PARTS, MELTING, BRITTLE, MORTAR, EXTRUDER, EXTRUDER_SIMPLE).addReRegistrations(ANY.Wax);}
	...
	static OreDictMaterial stone        (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(G_STONE, STONE, BRITTLE, MORTAR, EXTRUDER, EXTRUDER_SIMPLE).addReRegistrations(ANY.Stone);}
	...
	static OreDictMaterial stone        (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, SET_STONE       , aR, aG, aB, aA).put(G_STONE, STONE, BRITTLE, MORTAR, EXTRUDER, EXTRUDER_SIMPLE).addReRegistrations(ANY.Stone);}
	...
	Cu      = noblemetal    (  290, "Copper"                , "Cu"      ,  29,  34,  1357,  2835,  8.96      , SET_SHINY            , 255, 100,   0, 255).put(  G_INGOT_MACHINE_ORES        , UUM, COPPER_GROUP           ).aspects(TC.METALLUM, 2, TC.PERMUTATIO, 1               ).qual(2,  4.0,   64, 0).put(WASHING_PERSULFATE, EXTRUDER_SIMPLE, MORTAR, MOLTEN, RAILS),
	...
	Ge      = metalloid     (  320, "Germanium"             , "Ge"      ,  32,  40,  1211,  3106,  5.323     , SET_SHINY            , 212, 212, 212, 255).put(  G_INGOT_MACHINE_ORES        , UUM, CRYSTALLOGEN           ).aspects(TC.METALLUM, 2, TC.ELECTRUM, 1                 ).put(EXTRUDER_SIMPLE, MORTAR),
	...
	Th      = actinide      (  900, "Thorium"               , "Th"      ,  90, 140,  2115,  5061, 11.72      , SET_SHINY            ,   0,  30,   0, 255).put(  G_INGOT_ORES                                              ).aspects_met_rad(2, 1                                   ).qual(3, 6.0, 512, 2),
	Pa      = actinide      (  910, "Protactinium"          , "Pa"      ,  91, 138,  1841,  4300, 15.37      , SET_METALLIC                             ).put(  G_INGOT_ORES                                              ).aspects_met_rad(2, 1                                   ),
	U_238   = actinide      (  920, "Uranium"               , "U"       ,  92, 146,  1405,  4404, 18.95      , SET_METALLIC         ,  50, 240,  50, 255).put(  G_INGOT_ORES                                              ).aspects_met_rad(2, 1                                   ).qual(3, 6.0, 512, 3).put("Uranium238", "Uran"), // No, I could not make a Variable named "U" here. That would collide with the Material Unit.
	U_235   = actinide      (  921, "Uranium-235"           , "U-235"   ,  92, 143,  1405,  4404, 18.95      , SET_SHINY            ,  70, 250,  70, 255).put(  G_INGOT_ORES                                              ).aspects_met_rad(1, 2                                   ).qual(3, 6.0, 512, 3).put("UraniumEnriched"),
	...
	*/
	...
	HV = tier("HV").aspects(TC.MACHINA , 4),
	EV = tier("EV").aspects(TC.MACHINA , 5),
	IV = tier("IV").aspects(TC.MACHINA , 6),
	LuV = tier("LuV").aspects(TC.MACHINA , 7),
	ZPM = tier("ZPM").aspects(TC.MACHINA , 8),
	UV = tier("UV").aspects(TC.MACHINA , 9),
	PUV1 = tier("PUV1").aspects(TC.MACHINA , 10),
	PUV2 = tier("PUV2").aspects(TC.MACHINA , 11),
	PUV3 = tier("PUV3").aspects(TC.MACHINA , 12),
	PUV4 = tier("PUV4").aspects(TC.MACHINA , 13),
	PUV5 = tier("PUV5").aspects(TC.MACHINA , 14),
	Omega = tier("Omega").aspects(TC.MACHINA , 15),
	MAX = tier("MAX").aspects(TC.MACHINA , 16),
	...
	H2O                     = lquddcmp      ( 9800, "Water"                 , SET_FLUID             , 100, 100, 255, 255).put(UNRECYCLABLE, FOOD, MELTING)                                                                                                              .uumMcfg( 0, H              , 2*U, O                , 1*U)                                                                                                  .aspects(TC.AQUA, 2                 ).heat(CS.C  , CS.C+100).setDensity(1.0000).liquid(FL.Water.make(1000)), Water = H2O,
	HDO                     = lquddcmp      ( 9811, "Semiheavy Water"       , SET_FLUID             , 200, 200, 155, 255).put(UNRECYCLABLE, FOOD, MELTING, LIQUID)                                                                                                      .setMcfg( 0, H              , 1*U, D                , 1*U, O                , 1*U)                                                                          .aspects(TC.AQUA, 2, TC.TEMPESTAS, 1).heat(CS.C+2, CS.C+101).setDensity(1.0540),
	D2O                     = lquddcmp      ( 9812, "Heavy Water"           , SET_FLUID             , 255, 255, 100, 255).put(UNRECYCLABLE, FOOD, MELTING, LIQUID)                                                                                                      .setMcfg( 0, D              , 2*U, O                , 1*U)                                                                                                  .aspects(TC.AQUA, 2, TC.TEMPESTAS, 2).heat(CS.C+4, CS.C+102).setDensity(1.1056),
	T2O                     = lquddcmp      ( 9813, "Tritiated Water"       , SET_FLUID             , 255, 100, 100, 255).put(UNRECYCLABLE, FOOD, MELTING, LIQUID)                                                                                                      .setMcfg( 0, T              , 2*U, O                , 1*U)                                                                                                  .aspects(TC.AQUA, 2, TC.RADIO    , 1).heat(CS.C+7, CS.C+104).setDensity(1.2112),
	...
	SeaWater                = lqud          ( 9806, "Sea Water"             , SET_FLUID             ,  90,  90, 255, 255).put(UNRECYCLABLE, LIQUID)                                                                                                                     .setMcfg( 0, H              , 2*U, O                , 1*U)                                                                                                  .aspects(TC.TEMPESTAS, 2).heat(CS.C, CS.C+100).setDensity(1.0),
	...
	DistWater               = lquddcmp      ( 9808, "WaterDistilled"        , SET_FLUID             , 110, 110, 255, 255).put(UNRECYCLABLE, FOOD, MELTING)                                                                                                              .uumMcfg( 0, H              , 2*U, O                , 1*U)                                                                                                  .aspects(TC.AQUA, 2).heat(CS.C, CS.C+100).setDensity(1.0).setLocal("Distilled Water"),
	Air                     = gas           ( 9830, "Air"                   , SET_GAS               , 169, 208, 245,  15).put(TRANSPARENT, GASSES)                                                                                                                      .uumMcfg( 0, N              ,40*U, O                ,11*U, Ar               , 1*U)                                                                          .heat( 100,  200).setDensity(WEIGHT_AIR_G_PER_CUBIC_CENTIMETER),


	CO                      = gaschemelec   ( 9838, "Carbon Monoxide"       , SET_GAS               ,  10,  10,  10, 255).put(GASSES)                                                                                                                                   .uumMcfg( 0, C              , 1*U, O                , 1*U)                                                                                                  .heat( 100,  200),
	CO2                     = gaschemelec   ( 9836, "Carbon Dioxide"        , SET_GAS               ,  40,  40,  40, 255).put(GASSES)                                                                                                                                   .uumMcfg( 0, C              , 1*U, O                , 2*U)                                                                                                  .heat( 100,  200),
	CO3                     = gaschemelec   ( 9843, "Carbon Trioxide"       , SET_GAS               ,  45,  45,  45, 255).put(GASSES)                                                                                                                                   .uumMcfg( 0, C              , 1*U, O                , 3*U)                                                                                                  .heat( 100,  200),
	NO                      = gaschemelec   ( 9837, "Nitrogen Monoxide"     , SET_GAS               , 100, 175, 255, 255).put(GASSES)                                                                                                                                   .uumMcfg( 0, N              , 1*U, O                , 1*U)                                                                                                  .heat( 100,  200),
	NO2                     = gaschemelec   ( 9831, "Nitrogen Dioxide"      , SET_GAS               , 120, 190, 255, 255).put(GASSES)                                                                                                                                   .uumMcfg( 0, N              , 1*U, O                , 2*U)                                                                                                  .heat( 100,  200),
	SO2                     = gaschemdcmp   ( 9834, "Sulfur Dioxide"        , SET_GAS               , 255, 200,   0, 255).put(GASSES, "SulphurDioxide")                                                                                                                 .uumMcfg( 0, S              , 1*U, O                , 2*U)                                                                                                  .heat( 100,  200),
	SO3                     = gaschemdcmp   ( 9835, "Sulfur Trioxide"       , SET_GAS               , 255, 220,   0, 255).put(GASSES, "SulphurTrioxide")                                                                                                                .uumMcfg( 0, S              , 1*U, O                , 3*U)                                                                                                  .heat( 100,  200),
	CH4                     = gaschemelec   ( 9832, "Methane"               , SET_GAS               , 250, 200, 250, 255).put(GASSES, FLAMMABLE)                                                                                                                        .uumMcfg( 0, C              , 1*U, H                , 4*U)                                                                                                  .heat( 100,  200),
	HCl                     = gasaciddcmp   ( 9826, "Hydrochloric Acid"     , SET_GAS               ,   0, 255, 128, 255).put(GASSES)                                                                                                                                   .uumMcfg( 0, H              , 1*U, Cl               , 1*U)                                                                                                  .heat( 100,  200),
	H2S                     = gasaciddcmp   ( 8024, "Hydrosulfuric Acid"    , SET_GAS               , 241, 188, 133, 255).put(GASSES, FLAMMABLE)                                                                                                                        .uumMcfg( 0, H              , 2*U, S                , 1*U)                                                                                                  .heat( 191,  213),
	HF                      = gasaciddcmp   ( 9829, "Hydrogen Fluoride"     , SET_GAS               ,   0, 240, 240, 255).put(GASSES)                                                                                                                                   .uumMcfg( 0, H              , 1*U, F                , 1*U)                                                                                                  .heat( 189,  292),
	NH3                     = gasaciddcmp   ( 8025, "Ammonia"               , SET_GAS               , 114, 223, 232, 255).put(GASSES)                                                                                                                                   .uumMcfg( 0, N              , 1*U, H                , 3*U)                                                                                                  .heat( 195,  239),


	Sugar                   = dustdcmp      ( 9703, "Sugar"                 , SET_CUBE              , 250, 250, 250, 255).put(MELTING, FLAMMABLE, BRITTLE, MORTAR, FOOD)                                                                                       .uumMcfg( 0, C              ,12*U, H                ,22*U, O                ,11*U)                                                                          .aspects(TC.HERBA, 1, TC.AQUA, 1, TC.AER, 1).heat(459),
	...
	SiliconDioxide          = oredustdcmp   ( 8000, "Silicon Dioxide"       , SET_QUARTZ            , 200, 200, 200, 255).put(BRITTLE, QUARTZ, CRYSTALLISABLE)                                                                                                 .uumMcfg( 0, Si             , 1*U, O                , 2*U)                                                                                                  .aspects(TC.VITREUS, 2).heat(1986, 3220), SiO2 = SiliconDioxide,
	SiC                     = metalore      ( 8003, "Carborundum"           , SET_QUARTZ            ,  77,  77,  77, 255).put(BRITTLE, QUARTZ, DECOMPOSABLE)                                                                                                            .uumMcfg( 0, Si             , 1*U, C                , 1*U)                                                                                                  .aspects(TC.VITREUS, 1).alloyElectrolyzer(3000, 3100).qual(3, 8.0, 1280, 3),
	...
	Li2Fe2O4                = metalore      ( 8005, "Ferrite"               , SET_METALLIC          , 120, 120, 130, 255).put(DECOMPOSABLE, ELECTROLYSER, MAGNETIC_PASSIVE)                                                                                             .uumMcfg( 0, Li             , 2*U, Fe               , 2*U, O                , 4*U)                                                                          ,
	...
	H2O2                    = lquddcmp      ( 9809, "Hydrogen Peroxide"     , SET_FLUID             ,  20,  20, 255, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, H              , 2*U, O                , 2*U)                                                                                                  .aspects(TC.AQUA, 3).heat(CS.C, CS.C+150).setDensity(1.0),
	...
	H2SO4                   = lqudaciddcmp  ( 9824, "Sulfuric Acid"         , SET_FLUID             , 255, 128,   0, 255).put(LIQUID, "SulphuricAcid")                                                                                                                  .uumMcfg( 0, H              , 2*U, S                , 1*U, O                , 4*U)                                                                          .heat( 200,  400), SulfuricAcid = H2SO4,
	H2S2O7                  = lqudaciddcmp  ( 9844, "Disulfuric Acid"       , SET_FLUID             , 255, 150,   0, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, H              , 2*U, S                , 2*U, O                , 7*U)                                                                          .heat( 200,  400),
	HNO3                    = lqudaciddcmp  ( 9825, "Nitric Acid"           , SET_FLUID             , 128, 255,   0, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, H              , 1*U, N                , 1*U, O                , 3*U)                                                                          .heat( 231,  356), NitricAcid = HNO3,
	H2SiF6                  = lqudacidelec  ( 8011, "Hexafluorosilicic Acid", SET_FLUID             , 190, 200, 190, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, H              , 2*U, Si               , 3*U, F                , 6*U)                                                                          .heat( 250,  381), HexafluorosilicicAcid = H2SiF6,


	ChloroauricAcid         = lqudaciddcmp  ( 8400, "Chloroauric Acid"      , SET_FLUID             , 255, 200,  70, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, Au             , 1*U, Cl               , 4*U, H                , 1*U)                                                                          .heat( 200,  400),
	ChloroplatinicAcid      = lqudaciddcmp  ( 8401, "Chloroplatinic Acid"   , SET_FLUID             , 255,  70,  70, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, Pt             , 1*U, Cl               , 6*U, H                , 2*U)                                                                          .heat( 200,  400),
	StannicChloride         = lqudaciddcmp  ( 8402, "Stannic Chloride"      , SET_FLUID             , 210, 250, 250, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, Sn             , 1*U, Cl               , 4*U)                                                                                                  .heat( 200,  400),
	TiCl4                   = lqudaciddcmp  ( 8413, "Titanium Tetrachloride", SET_FLUID             , 233, 244, 222, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, Ti             , 1*U, Cl               , 4*U)                                                                                                  .heat( 249,  409), TitaniumTetrachloride = TiCl4,


	BlackVitriol            = lqudacidelec  ( 8403, "Black Vitriol"         , SET_FLUID             ,  66,  66,  66, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, Fe             , 1*U, S                , 1*U)                                                                                                  .heat( 200,  400),
	BlueVitriol             = lqudaciddcmp  ( 8404, "Blue Vitriol"          , SET_FLUID             ,  66,  66, 222, 255).put(LIQUID, "RomanVitriol", "CyprusVitriol")                                                                                                  .uumMcfg( 0, Cu             , 1*U, S                , 1*U, O                , 4*U)                                                                          .heat( 200,  400),
	GreenVitriol            = lqudaciddcmp  ( 8405, "Green Vitriol"         , SET_FLUID             ,  66, 222,  66, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, Fe             , 1*U, S                , 1*U, O                , 4*U)                                                                          .heat( 200,  400),
	RedVitriol              = lqudaciddcmp  ( 8406, "Red Vitriol"           , SET_FLUID             , 222,  66,  66, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, Co             , 1*U, S                , 1*U, O                , 4*U)                                                                          .heat( 200,  400),
	PinkVitriol             = lqudaciddcmp  ( 8407, "Pink Vitriol"          , SET_FLUID             , 222, 111, 111, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, Mg             , 1*U, S                , 1*U, O                , 4*U)                                                                          .heat( 200,  400),
	CyanVitriol             = lqudaciddcmp  ( 8408, "Cyan Vitriol"          , SET_FLUID             , 111, 222, 222, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, Ni             , 1*U, S                , 1*U, O                , 4*U)                                                                          .heat( 200,  400),
	WhiteVitriol            = lqudaciddcmp  ( 8409, "White Vitriol"         , SET_FLUID             , 222, 222, 222, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, Zn             , 1*U, S                , 1*U, O                , 4*U)                                                                          .heat( 200,  400),
	GrayVitriol             = lqudaciddcmp  ( 8410, "Gray Vitriol"          , SET_FLUID             , 111, 111, 111, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, Mn             , 1*U, S                , 1*U, O                , 4*U)                                                                          .heat( 200,  400),
	MartianVitriol          = lqudaciddcmp  ( 8411, "Martian Vitriol"       , SET_FLUID             , 222,  66, 222, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, Fe             , 2*U, S                , 3*U, O                ,12*U)                                                                          .heat( 200,  400),
	VitriolOfClay           = lqudaciddcmp  ( 8412, "Vitriol Of Clay"       , SET_FLUID             ,  66, 222, 222, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, Al2O3          , 5*U, S                , 3*U, O                , 9*U)                                                                          .heat( 200,  400),
	...
	Oil                     = create        ( 9850, "Oil"                   , SET_FLUID             ,  10,  10,  10, 255).put(G_CONTAINERS, FLAMMABLE)                                                                                                                                                                                                                                                                              .heat( 100,  400).aspects(TC.MORTUUS, 2, TC.LUX, 1),
	...
	Fuel                    = create        ( 9860, "Fuel"                  , SET_FLUID             , 255, 255,   0, 255).put(G_CONTAINERS, EXPLOSIVE, FLAMMABLE, "FuelOil")                                                                                                                                                                                                                                                        .heat( 100,  400).aspects(TC.MORTUUS, 1, TC.POTENTIA, 1).setLocal("Fuel Oil"),
	NitroFuel               = create        ( 9861, "Nitro-Fuel"            , SET_FLUID             , 200, 255,   0, 255).put(G_CONTAINERS, EXPLOSIVE, FLAMMABLE)                                                                                                       .setMcfg( 0, Glyceryl       , 1*U, Fuel             , 4*U)                                                                                                  .heat( 100,  400).aspects(TC.MORTUUS, 1, TC.POTENTIA, 2),
	...
	Propylene               = create        ( 9867, "Propylene"             , SET_FLUID             ,  90,  60, 140, 255).put(G_CONTAINERS, EXPLOSIVE, FLAMMABLE)                                                                                                                                                                                                                                                                   .heat( 100,  200).aspects(TC.MORTUUS, 1, TC.POTENTIA, 1),
	Ethylene                = create        ( 9868, "Ethylene"              , SET_FLUID             ,  64,  40, 100, 255).put(G_CONTAINERS, EXPLOSIVE, FLAMMABLE)                                                                                                                                                                                                                                                                   .heat( 100,  200).aspects(TC.MORTUUS, 1, TC.POTENTIA, 1),
	...
	ConstructionFoam        = create        ( 9883, "Construction Foam"     , SET_DULL              , 128, 128, 128, 255).put(G_CONTAINERS, DUSTS, STONE, BRITTLE, MELTING)                                                                                                                                                                                                                                                         .heat( 500, 2000).setLocal("C-Foam"),
	UUAmplifier             = create        ( 9884, "UU-Amplifier"          , SET_FLUID             , 196,   0, 255, 255).put(G_CONTAINERS)                                                                                                                                                                                                                                                                                         .heat(  50,  500),
	UUMatter                = create        ( 9885, "UU-Matter"             , SET_FLUID             ,  96,   0, 128, 255).put(G_CONTAINERS, GLOWING)                                                                                                                                                                                                                                                                                .heat(  50,  500),
	Latex                   = create        ( 9886, "Latex"                 , SET_FLUID             , 250, 250, 250, 255).put(G_CONTAINERS)                                                                                                                                                                                                                                                                                         .heat( 150,  500).aspects(TC.AQUA, 1, TC.LIMUS, 1),

	Glass                   = cent          ( 8001, "Glass"                 , SET_GLASS             , 250, 250, 250,  35).put(G_GLASS, MORTAR, CRYSTAL, UNRECYCLABLE, MELTING, EXTRUDER, EXTRUDER_SIMPLE, BRITTLE).lens(DYE_INDEX_White)                       .uumMcfg( 0, SiO2           , 1*U)                                                                                                                          .aspects(TC.VITREUS, 2).qual(1, 1.0, 1,  0).heat(1200),
	...
	Chalk                   = oredustelec   ( 9112, "Chalk"                 , SET_FINE              , 250, 250, 250, 255).put(MORTAR).setSmelting(CaCO3, 2*U3)                                                                                                 .setMcfg( 0, CaCO3          , 1*U)                                                                                                                          ,
	Dolomite                = oredustcent   ( 9163, "Dolomite"              , SET_FLINT             , 225, 205, 205, 255).put( MORTAR).setSmelting(CaCO3, U2)                                                                                                   .setMcfg( 0, CaCO3          , 1*U, MgCO3            , 1*U)                                                                                                  , // CaMg(CO3)2
	...
	Clay                    = dustelec      ( 8215, "Clay"                  , SET_ROUGH             , 200, 200, 220, 255).put(MORTAR)                                                                                                                                   .uumMcfg( 7, Li             , 1*U, Al2O3            , 2*U, SiO2             , 2*U, Na               , 2*U)                                                  .heat(1680),
	ClayBrown               = dustelec      ( 8276, "ClayBrown"             , SET_ROUGH             , 230, 140,  75, 255).put(MORTAR)                                                                                                                                   .uumMcfg( 7, Li             , 1*U, Al2O3            , 2*U, SiO2             , 2*U, K                , 2*U)                                                  .heat(1680).setLocal("Brown Clay"),
	Ceramic                 = dust          ( 8225, "Ceramic"               , SET_ROUGH             , 220, 130,  70, 255).put(PLATES, BRITTLE, MORTAR)                                                                                                                  .uumMcfg( 7, Li             , 1*U, Al2O3            , 2*U, SiO2             , 2*U)                                                                          .steal(Clay).heat(1680).setPulver(Clay, U2).setCompressing(null, 0).setBending(null, 0).setForging(null, 0).setSmashing(null, 0),
	...
	Rubber                  = create        ( 8217, "Rubber"                , SET_RUBBER            ,  20,  20,  20, 255).put(G_INGOT_MACHINE, APPROXIMATE, FLAMMABLE, EXTRUDER, EXTRUDER_SIMPLE, WIRES, MORTAR, BOUNCY, STRETCHY)                             .uumMcfg( 0, C              , 5*U, H                , 8*U)                                                                                                  .aspects(TC.MOTUS, 2).heat(410).setBurning(Ash, U9).setSmelting(null, 2*U3).qual(1, 1.5, 16, 0),
	Plastic                 = create        ( 8218, "Plastic"               , SET_DULL              , 200, 200, 200, 255).put(G_INGOT_MACHINE, APPROXIMATE, FLAMMABLE, EXTRUDER, EXTRUDER_SIMPLE, WIRES, MORTAR, BOUNCY, BRITTLE, MD.MFR)                      .uumMcfg( 0, C              , 1*U, H                , 2*U)                                                                                                  .aspects(TC.MOTUS, 2).heat(423).setBurning(Ash, U9).setSmelting(null, 2*U3).qual(1, 3.0, 32, 1),
	...
	Asphalt                 = dust          ( 8266, "Asphalt"               , SET_ROUGH             ,  88,  88,  99, 255).put(MELTING, EXTRUDER, EXTRUDER_SIMPLE, MOLTEN)                                                                                                                                                                                                                                                  .aspects(TC.TERRA, 1, TC.ITER, 1),
	...
	MeatRaw                 = meat          ( 9700, "MeatRaw"                                       , 255, 100, 100, 255).put(MD.MFR)                                                                                                                                                                                                                                                                                      .aspects(TC.CORPUS, 1).heat(477, 550).setLocal("Raw Meat").setSmelting(MeatCooked, U).setForging(MeatCooked, U),
	...
	FishRaw                 = meat          ( 9712, "FishRaw"                                       , 255, 150, 100, 255)                                                                                                                                                                                                                                                                                            .aspects(TC.CORPUS, 1).heat(477, 550).setLocal("Raw Fishmeal").setSmelting(FishCooked, U).setForging(FishCooked, U),
	...
	Cheese                  = orefood       ( 9780, "Cheese"                                        , 255, 234,   0, 255).put(INGOTS, MELTING, EXTRUDER, EXTRUDER_SIMPLE)                                                                                                                                                                                                                                                  .aspects(TC.FAMES, 1).heat(320, 500),
	Chili                   = dustfood      ( 9781, "Chili"                                         , 200,   0,   0, 255)                                                                                                                                                                                                                                                                                                           .aspects(TC.IGNIS, 1),
	Cocoa                   = dustfood      ( 9782, "Cocoa"                                         , 190,  95,   0, 255)                                                                                                                                                                                                                                                                                                           .aspects(TC.SANO, 1),
	Chocolate               = mixfood       ( 9783, "Chocolate"                                     , 100,  50,   0, 255).put(INGOTS, MELTING, EXTRUDER, EXTRUDER_SIMPLE)                                                                                      .setMcfg( 0, Cocoa          , 1*U, Sugar            , 1*U)                                                                                                  .aspects(TC.SANO, 1, TC.FAMES, 1).heat(CS.C+40, 400),
	...
	Sand                    = create        ( 8100, "Sand"                  , SET_SAND              , 250, 250, 200, 255).put(UNRECYCLABLE)                                                                                                                                                                                                                                                                                .setSmelting(Glass, U),
	...
	Topaz                   = valgemelec    ( 8306, "Topaz"                 , SET_GEM_HORIZONTAL    , 255, 128,   0, 127).lens(DYE_INDEX_Orange     )                                                                                                                   .uumMcfg( 0, Al2O3          , 5*U, SiO2             , 3*U, F                , 2*U, H2O              , 3*U)                                                  .aspects(TC.VITREUS, 4, TC.LUCRUM                   , 6).qual(3,  7.0,   256,  3),
	BlueTopaz               = valgemelec    ( 8307, "Blue Topaz"            , SET_GEM_HORIZONTAL    , 123, 150, 220, 127).lens(DYE_INDEX_Blue       )                                                                                                                   .uumMcfg( 0, Al2O3          , 5*U, SiO2             , 3*U, F                , 2*U, H2O              , 3*U)                                                  .aspects(TC.VITREUS, 4, TC.LUCRUM                   , 6).qual(3,  7.0,   256,  3),
	...
	*/
	...
	ArcaneCompound          = dust          ( 8366, "Arcane Compound"       , SET_ROUGH             , 180, 140,  50, 255).put(MAGICAL)                                                                                                                                                                                                                                                                                     .aspects(TC.PRAECANTIO, 1).setSmelting(ArcaneAsh, U*2),
	...
	Azurite                 = elec          ( 8420, "Azurite"               , SET_QUARTZ            , 109, 164, 247, 255).put(G_GEM_ORES, CRYSTAL, MORTAR, BRITTLE)                                                                                            .uumMcfg( 0, Cu             , 3*U, CO3              , 8*U, O                , 1*U, H2O              , 3*U)                                                  .aspects(TC.SENSUS , 1).setSmelting(Cu, U9),
	...
	HydratedCoal            = mixdust       ( 8335, "Hydrated Coal"         , SET_LIGNITE           ,  70,  70, 100, 255).put(BRITTLE, MORTAR, COAL)                                                                                                           .uumMcfg( 8, Coal           , 8*U, H2O              , 1*U)                                                                                                  ,
	...
	Electrotine             = redstone      ( 8359, "Electrotine"           , SET_REDSTONE          ,  60, 160, 230, 255).put(MOLTEN).lens(DYE_INDEX_Cyan)                                                                                                              .uumMcfg( 0, Sodalite       , 5*U, Cu               , 3*U, SiO2             , 1*U, Ar               , 1*U)                                                  .aspects(TC.ELECTRUM, 2).heat(1500, 3000).qual(0, 1.0, 64,0),
	...
	Stone                   =  metalmachine        ( 8500, "Stone" , SET_STONE                                        , 205, 205, 205, 255).put(G_INGOT_MACHINE, MORTAR, MOLTEN)                                                                                                                                                                                                                                                                        .aspects(TC.TERRA       , 1).qual(3, 1.0, 8, 1).heat(1100).setRGBaLiquid(192,  96,  64, 255),
	...
	Basalt                  = stonecent     ( 8505, "Basalt"                                        ,  30,  20,  20, 255)                                                                                                                                               .setMcfg( 0, Olivine        , 1*U, CaCO3            , 3*U, Flint            , 8*U, DarkAsh          , 4*U)                                                  .aspects(TC.TENEBRAE    , 1).qual(1, 3.0, 32, 2).heat(1673),
	...
	WroughtIron             = metalmachnd   ( 8643, "Wrought Iron"          , SET_METALLIC          , 200, 180, 180, 255).put(RAILS, MORTAR, MAGNETIC_PASSIVE, MOLTEN, "WrougtIron")                                                                                    .uumMcfg( 0, Fe             , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1).setPulver(Fe, U).steal(Fe).qual(3,  6.0,  384,  2).setRGBaLiquid(255, 80, 40, 255).alloyCentrifuge(Fe.mMeltingPoint + 200, Fe.mBoilingPoint),


	Alduorite               = setalore      ( 8760, "Alduorite"                                     , 159, 180, 180, 255)                                                                                                                                                                                                                                                                                                           .aspects(TC.METALLUM, 2, TC.PERMUTATIO                          , 1).heat(1567),
	Infuscolium             = metalore      ( 8761, "Infuscolium"                                   , 146,  33,  86, 255)                                                                                                                                                                                                                                                                                                           .aspects(TC.METALLUM, 2, TC.PRAECANTIO                          , 1).heat(1828),
	Rubracium               = metalore      ( 8762, "Rubracium"                                     , 151,  45,  45, 255)                                                                                                                                                                                                                                                                                                           .aspects(TC.METALLUM, 2, TC.LUCRUM                              , 1).heat(1847),
	Meutoite                = metalore      ( 8763, "Meutoite"                                      ,  95,  82, 105, 255)                                                                                                                                                                                                                                                                                                           .aspects(TC.METALLUM, 2, TC.ALIENIS                             , 1).heat(1837),
	Lemurite                = metalore      ( 8764, "Lemurite"                                      , 219, 219, 219, 255)                                                                                                                                                                                                                                                                                                           .aspects(TC.METALLUM, 2, TC.MOTUS                               , 1).heat(1179),
	Ceruclase               = metalore      ( 8765, "Ceruclase"                                     , 140, 189, 208, 255).qual(3,  6.0, 1280, 2)                                                                                                                                                                                                                                                                                    .aspects(TC.METALLUM, 2, TC.TEMPESTAS                           , 1).heat(1867),
	// 8766 is free now
	Oureclase               = metalore      ( 8767, "Oureclase"                                     , 183,  98,  21, 255).qual(3,  6.0, 1920, 3)                                                                                                                                                                                                                                                                                    .aspects(TC.METALLUM, 2, TC.AER                                 , 1).heat(2789),
	Kalendrite              = metalore      ( 8768, "Kalendrite"                                    , 170,  91, 189, 255).qual(3,  5.0, 2560, 3)                                                                                                                                                                                                                                                                                    .aspects(TC.METALLUM, 2, TC.ORDO                                , 1).heat(2679),
	Orichalcum              = metalore      ( 8769, "Orichalcum"                                    ,  84, 122,  56, 255).qual(3,  4.5, 3456, 3)                                                                                                                                                                                                                                                                                    .aspects(TC.METALLUM, 2, TC.TERRA                               , 1).heat(2897),
	Carmot                  = metalore      ( 8770, "Carmot"                                        , 217, 205, 140, 255).qual(3, 16.0,  128, 1)                                                                                                                                                                                                                                                                                    .aspects(TC.METALLUM, 2, TC.NEBRISUM                            , 1).heat(1178),
	Sanguinite              = metalore      ( 8771, "Sanguinite"                                    , 185,   0,   0, 255).qual(3,  3.0, 4480, 4)                                                                                                                                                                                                                                                                                    .aspects(TC.METALLUM, 2, TC.SANO                                , 1).heat(3104),
	Vyroxeres               = metalore      ( 8772, "Vyroxeres"                                     ,  85, 224,   1, 255).qual(3,  9.0,  768, 3)                                                                                                                                                                                                                                                                                    .aspects(TC.METALLUM, 2, TC.VENENUM                             , 1).heat(2348),
	Eximite                 = metalore      ( 8773, "Eximite"                                       , 124,  90, 150, 255).qual(3,  5.0, 2560, 3)                                                                                                                                                                                                                                                                                    .aspects(TC.METALLUM, 2, TC.ITER                                , 1).heat(2758),
	Prometheum              = metalore      ( 8774, "Prometheum"                                    ,  90, 129,  86, 255).qual(3,  8.0,  512, 1)                                                                                                                                                                                                                                                                                    .aspects(TC.METALLUM, 2, TC.POTENTIA                            , 1).heat(1067),
	Ignatius                = metalore      ( 8775, "Ignatius"                                      , 255, 169,  83, 255).qual(3, 12.0,  512, 2)                                                                                                                                                                                                                                                                                    .aspects(TC.METALLUM, 2, TC.IGNIS                               , 1).heat(1978),
	Vulcanite               = metalore      ( 8776, "Vulcanite"                                     , 255, 132,  72, 255).qual(3,  5.0, 3840, 3)                                                                                                                                                                                                                                                                                    .aspects(TC.METALLUM, 2, TC.VITREUS                             , 1).heat(2978),
	DeepIron                = metalore      ( 8641, "Deep Iron"                                     ,  73,  91, 105, 255).qual(3,  6.0,  384, 2).put(MAGNETIC_PASSIVE)                                                                                                                                                                                                                                                              .aspects(TC.METALLUM, 2, TC.MAGNETO                             , 1).heat(Fe),
	ShadowIron              = metalore      ( 8670, "Shadow Iron"                                   ,  95,  76,  63, 255).qual(3,  6.0,  384, 2).put(MAGNETIC_PASSIVE)                                                                                                                                                                                                                                                              .aspects(TC.METALLUM, 2, TC.TENEBRAE                            , 1).heat(WroughtIron),
	Adamantine              = metalore      ( 8784, "Adamantine"                                    , 255,   0,  64, 255).qual(3, 10.0, 4500, 5).put(MAGNETIC_PASSIVE, DECOMPOSABLE, ELECTROLYSER, WITHER_PROOF, ENDER_DRAGON_PROOF)                                    .uumMcfg( 0, Ad             , 3*U, O                , 4*U)                                                                                                  .aspects(TC.METALLUM, 5, TC.PRAECANTIO                          , 5).heat(Ad),
	AstralSilver            = slloymachore  ( 8676, "Astral Silver"                                 , 230, 230, 255, 255).qual(3, 10.0,   64, 2).put(MAGICAL, CENTRIFUGE, MOLTEN, WASHING_MERCURY, VALUABLE, ENDER_DRAGON_PROOF)                                        .setMcfg( 2, Ag             , 2*U, Ma               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.LUCRUM          , 1, TC.PRAECANTIO  , 1).heat(Ag),
	Midasium                = slloymachore  ( 8677, "Midasium"                                      , 255, 200,  40, 255).qual(3, 12.0,   64, 2).put(MAGICAL, CENTRIFUGE, MOLTEN, WASHING_MERCURY, VALUABLE, WITHER_PROOF)                                              .setMcfg( 2, Au             , 2*U, Ma               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.LUCRUM          , 2, TC.PRAECANTIO  , 1).heat(Au),
	Mithril                 = slloymachore  ( 8678, "Mithril"                                       , 100, 140, 250, 255).qual(3, 14.0,   64, 3).put(MAGICAL, CENTRIFUGE, MOLTEN, WASHING_MERCURY, VALUABLE)                                                            .setMcfg( 2, Pt             , 2*U, Ma               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.LUCRUM          , 3, TC.PRAECANTIO  , 1).heat(Pt),
	ShadowSteel             = alloy         ( 8671, "Shadow Steel"                                  , 136, 115,  98, 255).qual(3,  6.0,  768, 2).put(MAGNETIC_PASSIVE)                                                                                                  .setMcfg( 0, ShadowIron     , 1*U, Lemurite         , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.TENEBRAE        , 1, TC.TELUM       , 1).alloyCentrifuge().visDefault(ShadowIron, Lemurite),
	Inolashite              = alloy         ( 8777, "Inolashite"                                    , 148, 216, 187, 255).qual(3,  8.0, 2304, 3)                                                                                                                        .setMcfg( 0, Alduorite      , 1*U, Ceruclase        , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.AER             , 1, TC.AQUA        , 1).alloyCentrifuge().visDefault(Alduorite, Ceruclase),
	Haderoth                = alloy         ( 8778, "Haderoth"                                      , 119,  52,  30, 255).qual(3, 10.0, 3200, 3)                                                                                                                        .setMcfg( 0, Mithril        , 1*U, Rubracium        , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.LUCRUM          , 1, TC.PRAECANTIO  , 1).alloyCentrifuge().visDefault(Rubracium),
	Celenegil               = alloy         ( 8779, "Celenegil"                                     , 148, 204,  72, 255).qual(3, 10.0, 4096, 3)                                                                                                                        .setMcfg( 0, Pt             , 1*U, Orichalcum       , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.NEBRISUM        , 1, TC.VITREUS     , 1).alloyCentrifuge().visDefault(Orichalcum),
	Desichalkos             = alloy         ( 8781, "Desichalkos"                                   , 114,  47, 168, 255).qual(3, 11.0, 4608, 4)                                                                                                                        .setMcfg( 0, Eximite        , 1*U, Meutoite         , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.ITER            , 1, TC.ALIENIS     , 1).alloyCentrifuge().visDefault(Eximite, Meutoite),
	Tartarite               = alloy         ( 8782, "Tartarite"                                     , 255, 118,  60, 255).qual(3, 20.0, 7680, 5).put(MAGNETIC_PASSIVE, WITHER_PROOF, ENDER_DRAGON_PROOF)                                                                .uumMcfg( 0, Adamantine     , 1*U, Atl              , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM    , 1, TC.COGNITO     , 1).alloyCentrifuge(),
	Amordrine               = alloy         ( 8783, "Amordrine"                                     , 169, 141, 177, 255).qual(3,  7.0, 3328, 3)                                                                                                                        .setMcfg( 0, Prometheum     , 1*U, Kalendrite       , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.ORDO            , 1, TC.POTENTIA    , 1).alloyCentrifuge().visDefault(Prometheum, Kalendrite),


	Electrum                = slloymachore  ( 8600, "Electrum"                                      , 255, 255, 100, 255).put(RAILS, WASHING_MERCURY, MORTAR, MOLTEN, WITHER_PROOF, ENDER_DRAGON_PROOF).qual(3, 12.0,   64, 2)                                          .uumMcfg( 0, Ag             , 1*U, Au               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.LUCRUM, 2).alloyCentrifuge(),
	SterlingSilver          = slloymachine  ( 8601, "Sterling Silver"                               , 250, 220, 225, 255).put(MORTAR, VALUABLE, ENDER_DRAGON_PROOF).qual(3, 13.0,  128, 2)                                                                              .uumMcfg( 0, Cu             , 1*U, Ag               , 4*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.LUCRUM, 2).alloyCentrifuge(),
	RoseGold                = slloymachine  ( 8602, "Rose Gold"                                     , 255, 230,  30, 255).put(MORTAR, VALUABLE, WITHER_PROOF, "Tumbaga").qual(3, 14.0,  128, 2)                                                                         .uumMcfg( 0, Cu             , 1*U, Au               , 4*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.LUCRUM, 2).alloyCentrifuge(),
	Angmallen               = slloymachine  ( 8603, "Angmallen"                                     , 215, 225, 138, 255).put(MORTAR, MAGNETIC_PASSIVE, MOLTEN).qual(3, 10.0,  128, 2)                                                                                  .uumMcfg( 0, Au             , 1*U, WroughtIron      , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.LUCRUM, 1).alloyCentrifuge(),
	InductiveAlloy          = slloymachine  ( 8604, "GoldInductive"                                 , 255, 150,  75, 255).put(MORTAR, MAGNETIC_PASSIVE, MOLTEN)                                                                                                         .uumMcfg( 0, Au             , 1*U, Redstone         , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.MAGNETO, 1).alloyCentrifuge().setLocal("Inductive Alloy"),
	Cd_In_Ag_Alloy          = alloymachine  ( 8605, "Cd-In-Ag-Alloy"                                , 100, 100, 128, 255)                                                                                                                                               .uumMcfg( 0, Cd             , 1*U, In               , 1*U, Ag               , 1*U)                                                                          .aspects(TC.METALLUM, 2, TC.TENEBRAE, 1).alloyCentrifuge(),
	GildedIron              = slloymachine  ( 8606, "Gilded Iron"                                   , 255, 230,  80, 255).put(COATED, CENTRIFUGE, MAGNETIC_PASSIVE, WITHER_PROOF).qual(3, 12.0,  256, 2)                                                                .setMcfg( 9, Fe             , 9*U, Au               , 1*U)                                                                                                  .aspects(TC.METALLUM, 3, TC.LUCRUM, 1).setSmelting(Fe, U).setForging(Fe, U), // from Flaxbeard, obviously not an Alloy, but coated in Gold. This also gives an example on how to make such things as coated metals.


	Brass                   = alloymachine  ( 8620, "Brass"                                         , 255, 180,   0, 255).put(EXTRUDER_SIMPLE, MORTAR, MOLTEN).qual(2, 7.0, 96, 1)                                                                             .uumMcfg( 0, Cu             , 3*U, Zn               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1).alloyCentrifuge(1160, Cu.mBoilingPoint),
	CobaltBrass             = alloymachine  ( 8621, "Cobalt Brass"                                  , 180, 180, 160, 255).put(MOLTEN).qual(3,  8.0, 256, 2)                                                                                                             .uumMcfg( 0, Brass          , 7*U, Al               , 1*U, Co               , 1*U)                                                                          .aspects(TC.METALLUM, 2, TC.FABRICO, 1).alloyCentrifuge(),
	AluminiumAlloy          = alloymachine  ( 8622, "Aluminium Alloy"                               , 200, 200, 180, 255).put(CENTRIFUGE)                                                                                                                               .uumMcfg(45, Al             ,45*U, Si               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.FABRICO, 1).qual(Al),


	Bronze                  = alloymachine  ( 8610, "Bronze"                                        , 210, 130,  60, 255).put(RAILS, EXTRUDER_SIMPLE, MORTAR, MOLTEN).qual(3, 6.0,  192, 2)                                                                    .uumMcfg( 0, Cu             , 3*U, Sn               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1).alloyCentrifuge(Cu.mMeltingPoint, Cu.mBoilingPoint),
	BlackBronze             = alloymachine  ( 8611, "Black Bronze"          , SET_DULL              , 100,  50, 125, 255).put(MORTAR, MOLTEN).qual(3, 12.0,  256, 2)                                                                                                    .uumMcfg( 0, Cu             , 3*U, Electrum         , 2*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1).alloyCentrifuge(),
	BismuthBronze           = alloymachine  ( 8612, "Bismuth Bronze"        , SET_DULL              , 100, 125, 125, 255).put(EXTRUDER_SIMPLE, MORTAR, MOLTEN).qual(3,  8.0,  256, 2)                                                                          .setMcfg( 0, Bi             , 1*U, Brass            , 4*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1).alloyCentrifuge(),
	Hepatizon               = alloymachine  ( 8613, "Hepatizon"                                     , 117,  94, 117, 255).put(MORTAR, MOLTEN).qual(3, 12.0,  128, 2)                                                                                                    .uumMcfg( 0, Au             , 1*U, Bronze           , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1).alloyCentrifuge(),


	Steel                   = alloymachore  ( 8630, "Steel"                                         , 130, 130, 130, 255).put(MOLTEN, RAILS, MORTAR, MAGNETIC_PASSIVE).qual(3,  6.0,  512, 2)                                                                           .uumMcfg( 0, WroughtIron    , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.ORDO, 1).heat(2046, Fe.mBoilingPoint, Fe.mPlasmaPoint).setRGBaLiquid(255, 20, 10, 255),
	BlackSteel              = alloymachine  ( 8631, "Black Steel"                                   ,  90,  90,  90, 255).put(MOLTEN).qual(3,  6.5,  768, 2)                                                                                                            .uumMcfg( 0, Ni             , 1*U, BlackBronze      , 1*U, Steel            , 3*U)                                                                          .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.INSTRUMENTUM, 1).alloyCentrifuge(),
	RedSteel                = alloymachine  ( 8632, "Red Steel"                                     , 140, 100, 100, 255).put(MOLTEN).qual(3,  7.0,  896, 2)                                                                                                            .setMcfg( 0, SterlingSilver , 1*U, BismuthBronze    , 1*U, Steel            , 2*U, BlackSteel       , 4*U)                                                  .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.INSTRUMENTUM, 1).alloyCentrifuge(),
	BlueSteel               = alloymachine  ( 8633, "Blue Steel"                                    , 100, 100, 140, 255).put(MOLTEN).qual(3,  7.5, 1024, 2)                                                                                                            .uumMcfg( 0, RoseGold       , 1*U, Brass            , 1*U, Steel            , 2*U, BlackSteel       , 4*U)                                                  .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.INSTRUMENTUM, 1).alloyCentrifuge(),
	DamascusSteel           = alloymachine  ( 8634, "Damascus Steel"                                , 110, 110, 110, 255).put(MOLTEN, CENTRIFUGE, MAGNETIC_PASSIVE).qual(3,  8.0, 1280, 2)                                                                              .uumMcfg(50, Steel          ,50*U, V                , 1*U, W                , 1*U)                                                                          .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.INSTRUMENTUM, 1, TC.TELUM, 1),
	VanadiumSteel           = alloymachine  ( 8653, "VanadiumSteel"                                 , 100, 100, 100, 255).put(MOLTEN, MAGNETIC_PASSIVE).qual(3, 7.0, 512, 3)                                                                                            .uumMcfg( 0, Steel          , 4*U, V                , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.INSTRUMENTUM, 1).setLocal("Vanadiumsteel").alloyCentrifuge(),
	TungstenSteel           = alloymachine  ( 8635, "Tungstensteel"                                 , 100, 100, 160, 255).put(MOLTEN, RAILS, MAGNETIC_PASSIVE, "TungstenSteel", "Wolframsteel", "WolframSteel").qual(3, 10.0, 5120, 4)                                  .uumMcfg( 0, Steel          , 1*U, W                , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.TUTAMEN, 1).alloyCentrifuge(),
	TungstenCarbide         = alloymachine  ( 8638, "Tungsten Carbide"                              , 123, 123, 123, 255).put(RAILS, "Carbide", "WolframCarbide").qual(3, 10.0, 5120, 4)                                                                                .uumMcfg( 0, W              , 1*U, C                , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.TUTAMEN, 1).setDensity(15.6).alloyCentrifuge(3070, 6270),
	HSLA                    = alloymachine  ( 8637, "HSLA-Steel"                                    , 210, 210, 255, 255).put(MOLTEN, RAILS, CENTRIFUGE, MORTAR, MAGNETIC_PASSIVE, "HSLA")                                                                              .uumMcfg( 0, WroughtIron    , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.ORDO, 1).steal(Steel).heat(1873, Fe.mBoilingPoint, Fe.mPlasmaPoint),
	SpringSteel             = alloymachine  ( 8639, "HSLA-SpringSteel"                              , 220, 100, 100, 255).put(CENTRIFUGE, MAGNETIC_PASSIVE)                                                                                                             .uumMcfg(45, HSLA           ,45*U, Redstone         , 2*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.ORDO, 1).steal(HSLA).setLocal("Spring Steel"),
	AnnealedCopper          = metalnd       ( 8640, "Annealed Copper"       , SET_SHINY             , 255, 120,  20, 255).put(MOLTEN, EXTRUDER_SIMPLE, MORTAR, WIRES, RAILS)                                                                                   .uumMcfg( 0, Cu             , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.PERMUTATIO, 1           ).setPulver(Cu      , U)                                                                                                                                                        .steal(Cu).alloyCentrifuge(2800, Cu.mBoilingPoint),
	PigIron                 = metalmachore  ( 8642, "Pig Iron"                                      , 200, 180, 180, 255).put(MOLTEN, MORTAR, MAGNETIC_PASSIVE)                                                                                                         .uumMcfg( 0, WroughtIron    , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1         ).setPulver(Fe      , U).setSmelting(WroughtIron    , U)                                                                                                                        .steal(WroughtIron).qual(3,  6.0,  384,  2),
	...
	IronMagnetic            = metalmachnd   ( 8645, "IronMagnetic"          , SET_MAGNETIC          , 200, 200, 200, 255).put(LAYERED, MORTAR, MAGNETIC_ACTIVE)                                                                                                         .uumMcfg( 0, Fe             , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.MAGNETO, 1              ).setBending(Fe     , U).setCompressing(Fe      , U).setPulver(Fe       , U).setSmashing(Fe     , U).setSmelting(Fe     , U).setWorking(Fe      , U).setForging(Fe      , U)    .steal(Fe).setLocal("Magnetic Iron"),
	SteelMagnetic           = metalmachnd   ( 8646, "SteelMagnetic"         , SET_MAGNETIC          , 128, 128, 128, 255).put(LAYERED, MORTAR, MAGNETIC_ACTIVE)                                                                                                         .uumMcfg( 0, Steel          , 1*U)                                                                                                                          .aspects(TC.METALLUM, 1, TC.ORDO, 1, TC.MAGNETO, 1  ).setBending(Steel  , U).setCompressing(Steel   , U).setPulver(Steel    , U).setSmashing(Steel  , U).setSmelting(Steel  , U).setWorking(Steel   , U).setForging(Steel   , U)    .steal(Steel).setLocal("Magnetic Steel"),
	NeodymiumMagnetic       = metalmachnd   ( 8647, "NeodymiumMagnetic"     , SET_MAGNETIC          , 100, 100, 100, 255).put(LAYERED, MORTAR, MAGNETIC_ACTIVE)                                                                                                         .uumMcfg( 0, Nd             , 1*U)                                                                                                                          .aspects(TC.METALLUM, 1, TC.MAGNETO, 3              ).setBending(Fe     , U).setCompressing(Nd      , U).setPulver(Nd       , U).setSmashing(Nd     , U).setSmelting(Nd     , U).setWorking(Nd      , U).setForging(Nd      , U)    .steal(Nd).setLocal("Magnetic Neodymium"),
	...
	MeteoricSteel           = alloymachine  ( 8650, "Meteoric Steel"        , SET_SPACE             , 130, 120, 100, 255).put(MOLTEN, MAGNETIC_ACTIVE, RAILS)                                                                                                           .uumMcfg( 0, MeteoricIron   , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.MAGNETO, 1, TC.ORDO, 1).steal(Steel).qual(3, 7.0, 800, 2).heat(Steel.mMeltingPoint + 200, Steel.mBoilingPoint + 200),
	SteelGalvanized         = alloymachine  ( 8651, "SteelGalvanized"                               , 250, 240, 240, 255).put(COATED, CENTRIFUGE).qual(3,  7.0, 768, 2)                                                                                                 .setMcfg( 9, Steel          , 9*U, Zn               , 1*U)                                                                                                  .aspects(TC.METALLUM, 3, TC.SANO, 1).setSmelting(Steel, U).setForging(Steel, U).setLocal("Galvanized Steel"),
	TungstenSintered        = alloymachnd   ( 8652, "TungstenSintered"      , SET_METALLIC          ,  70,  70,  70, 255).put(RAILS).qual(3, 8.0, 5120, 3)                                                                                                              .uumMcfg( 0, W              , 1*U)                                                                                                                          .aspects(TC.METALLUM, 3, TC.TUTAMEN, 1).steal(W).setAllToTheOutputOf(W).setForging(null, U).setCutting(null, U).setWorking(null, U).setSmashing(null, U).setLocal("Sintered Tungsten"),
	TitaniumGold            = alloymachine  ( 8654, "Titanium-Gold"                                 , 222, 222, 255, 255).put(MOLTEN).qual(3, 12.0, 5120, 4)                                                                                                            .uumMcfg( 0, Ti             , 3*U, Au               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 3, TC.LUCRUM, 1).alloyCentrifuge(),
	Ta4HfC5                 = alloymachine  ( 8802, "Tantalum Hafnium Carbide"                      ,  32, 128,  32, 255)                                                                                                                                               .uumMcfg( 0, Ta             , 4*U, Hf               , 1*U, C                , 5*U)                                                                          .aspects(TC.METALLUM, 2, TC.GELUM, 2).heat(4263).alloyCentrifuge(),

	ElectrotineAlloy        = alloy         ( 8658, "Electrotine Alloy"     , SET_DULL              , 100, 180, 255, 255).put(WIRES, MOLTEN, EXTRUDER_SIMPLE)                                                                                                  .uumMcfg( 1, WroughtIron    , 1*U, Electrotine      , 8*U)                                                                                                  .aspects(TC.ELECTRUM, 3).alloyCentrifuge(1400, Fe.mBoilingPoint),
	RedAlloy                = alloy         ( 8660, "Red Alloy"             , SET_DULL              , 200,   0,   0, 255).put(WIRES, MOLTEN, EXTRUDER_SIMPLE)                                                                                                  .uumMcfg( 1, Cu             , 1*U, Redstone         , 4*U)                                                                                                  .aspects(TC.MACHINA, 3).alloyCentrifuge(1400, Cu.mBoilingPoint),
	BlueAlloy               = alloy         ( 8659, "Blue Alloy"            , SET_DULL              , 100, 180, 255, 255).put(WIRES, MOLTEN, EXTRUDER_SIMPLE)                                                                                                  .uumMcfg( 1, Ag             , 1*U, Nikolite         , 4*U)                                                                                                  .aspects(TC.ELECTRUM, 3).alloyCentrifuge(1400, Ag.mBoilingPoint),
	PurpleAlloy             = alloy         ( 8657, "Purple Alloy"          , SET_DULL              , 255, 120, 255, 255).put(WIRES, MOLTEN, EXTRUDER_SIMPLE)                                                                                                  .uumMcfg( 1, RedAlloy       , 1*U, BlueAlloy        , 1*U)                                                                                                  .aspects(TC.MACHINA, 3, TC.ELECTRUM, 3).alloyCentrifuge(1400, Ag.mBoilingPoint),
	Invar                   = alloymachine  ( 8661, "Invar"                                         , 220, 220, 150, 255).put(MORTAR, MAGNETIC_PASSIVE, MOLTEN).qual(3,  6.0,    256,  2)                                                                               .uumMcfg( 0, WroughtIron    , 2*U, Ni               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.GELUM, 1).alloyCentrifuge(),
	Constantan              = alloymachine  ( 8662, "Constantan"                                    , 227, 150, 128, 255).put(MORTAR, MAGNETIC_PASSIVE, MOLTEN, "Cupronickel").qual(3,  6.0,  64,  1)                                                                   .uumMcfg( 0, Cu             , 1*U, Ni               , 1*U)                                                                                                  .alloyCentrifuge(), Cupronickel = Constantan,
	Nichrome                = alloymachine  ( 8663, "Nichrome"                                      , 205, 206, 246, 255).put(MOLTEN).qual(3,  6.0,   64,  2)                                                                                                           .uumMcfg( 0, Ni             , 4*U, Cr               , 1*U)                                                                                                  .alloyCentrifuge(),
	Kanthal                 = alloymachine  ( 8664, "Kanthal"                                       , 194, 210, 223, 255).put(MOLTEN).qual(3,  6.0,   64,  2)                                                                                                           .uumMcfg( 0, WroughtIron    , 1*U, Al               , 1*U, Cr               , 1*U)                                                                          .alloyCentrifuge(),
	Magnalium               = alloymachine  ( 8665, "Magnalium"             , SET_DULL              , 200, 190, 255, 255).put(MOLTEN).qual(3,  6.0,  256,  2)                                                                                                           .uumMcfg( 0, Mg             , 1*U, Al               , 2*U)                                                                                                  .alloyCentrifuge(),
	StainlessSteel          = slloymachine  ( 8636, "Stainless Steel"                               , 200, 200, 220, 255).put(MOLTEN, RAILS).qual(3,  7.0, 480,  2)                                                                                                     .uumMcfg( 0, WroughtIron    , 4*U, Invar            , 3*U, Cr               , 1*U, Mn               , 1*U)                                                  .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.VITREUS, 1).alloyCentrifuge(),
	Ultimet                 = slloymachine  ( 8666, "Ultimet"                                       , 180, 180, 230, 255).put(MOLTEN).qual(3,  8.0,1024,  3)                                                                                                            .uumMcfg( 0, Co             , 5*U, Cr               , 2*U, Ni               , 1*U, Mo               , 1*U)                                                  .alloyCentrifuge(), // 54% Co, 26% Cr, 9% Ni, 5% Mo, 3% Fe, 2% W, 0.8% Mn, 0.3% Si, 0.08% Ni and 0.06% C
	TinAlloy                = alloymachine  ( 8667, "Tin Alloy"                                     , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER_SIMPLE).qual(3,  6.5,    96,  2)                                                                        .uumMcfg( 0, Sn             , 1*U, WroughtIron      , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.FABRICO, 1).alloyCentrifuge(),
	BatteryAlloy            = alloy         ( 8668, "Battery Alloy"         , SET_DULL              , 156, 124, 160, 255).put(MORTAR, MOLTEN, EXTRUDER_SIMPLE)                                                                                                 .uumMcfg( 0, Pb             , 4*U, Sb               , 1*U)                                                                                                  .alloyCentrifuge(),
	SolderingAlloy          = alloy         ( 8669, "Soldering Alloy"       , SET_DULL              , 220, 220, 230, 255).put(MORTAR, MOLTEN, BRITTLE, SOLDERING_MATERIAL, SOLDERING_MATERIAL_GOOD, WIRES)                                                              .uumMcfg( 0, Sn             , 9*U, Sb               , 1*U)                                                                                                  .alloyCentrifuge(),
	IronWood                = alloymachine  ( 8672, "IronWood"              , SET_WOOD              , 150, 140, 110, 255).put(MAGICAL, WOOD, EXTRUDER_SIMPLE, MORTAR, MAGNETIC_PASSIVE, MOLTEN, MD.TF).qual(2, 6.0,  384,  2).setLocal("Ironwood")             .setMcfg(18, WroughtIron    , 8*U, LiveRoot         , 9*U, Angmallen        , 2*U)                                                                          .aspects(TC.METALLUM, 2, TC.ARBOR, 1, TC.PRAECANTIO, 1).alloyCentrifuge(),
	...
	Knightmetal             = alloymachine  ( 8674, "Knightmetal"                                   , 210, 240, 200, 255).put(MAGICAL, CENTRIFUGE, MAGNETIC_PASSIVE, MOLTEN, MORTAR, "KnightMetal", MD.TF).qual(3,  8.0, 1024,  3)                                      .setMcfg( 2, Steel          , 2*U, Ma               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.TELUM, 1, TC.PRAECANTIO, 1).heat(Steel.mMeltingPoint+100, Steel.mBoilingPoint+100).visDefault(),
	...
	Thaumium                = alloymachine  ( 8679, "Thaumium"                                      , 150, 100, 200, 255).put(MAGICAL, CENTRIFUGE, MAGNETIC_PASSIVE, MOLTEN).qual(3, 12.0,   256,  3)                                                                   .setMcfg( 1, Fe             , 1*U, Ma               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 1).heat(Fe.mMeltingPoint+500, Fe.mBoilingPoint+1000),
	DarkThaumium            = alloymachine  ( 8680, "Dark Thaumium"                                 , 100,  75,  75, 255).put(MAGICAL, CENTRIFUGE, MAGNETIC_PASSIVE, MOLTEN).qual(3, 12.0,   512,  3)                                                                                                                                                                                                                               ,
	...
	Osmiridium              = alloymachine  ( 8682, "Osmiridium"                                    , 100, 100, 255, 255).put(VALUABLE, MOLTEN).qual(3, 11.0, 3840, 4)                                                                                                  .uumMcfg( 0, Os             , 1*U, Ir               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.MACHINA, 2, TC.NEBRISUM, 1).alloyCentrifuge(),
	Sunnarium               = slloymachine  ( 8683, "Sunnarium"                                     , 255, 255,   0, 255).put(GLOWING, LIGHTING)                                                                                                                                                                                                                                                                                    ,
	...
	VanadiumGallium         = slloy         ( 8686, "Vanadium-Gallium"                              , 128, 128, 140, 255).put(BRITTLE)                                                                                                                                  .uumMcfg( 0, V              , 3*U, Ga               , 1*U)                                                                                                  .alloyCentrifuge(),
	YttriumBariumCuprate    = alloy         ( 8687, "Yttrium-Barium-Cuprate"                        ,  80,  64,  70, 255).put(BRITTLE, ELECTROLYSER, LAYERED)                                                                                                           .uumMcfg( 6, Y              , 1*U, Ba               , 2*U, Cu               , 3*U, O                , 7*U)                                                  .heat(1200),
	...
	AluminiumBrass          = alloymachine  ( 8700, "Aluminium Brass"                               , 220, 220, 130, 255).put(MOLTEN, "AluminumBrass").qual(2, 6.0,  64,  2)                                                                                            .uumMcfg( 0, Al             , 3*U, Cu               , 1*U)                                                                                                  .aspects(TC.STRONTIO, 1),
	Ardite                  = metalore      ( 8707, "Ardite"                                        , 200, 120,  20, 255).qual(2, 6.0,  64,  2)                                                                                                                                                                                                                                                                                     .aspects(TC.STRONTIO, 1),
	Aredrite                = metalore      ( 8701, "Aredrite"                                      , 255, 255,   0, 255).put(MOLTEN).qual(2, 6.0,   64,  2)                                                                                                                                                                                                                                                                        .aspects(TC.STRONTIO, 1).visDefault(),
	Alumite                 = alloymachine  ( 8702, "Alumite"                                       , 230, 100, 230, 255).put(MOLTEN).qual(2, 1.5,   64,  0)                                                                                                            .setMcfg( 9, Al             , 5*U, WroughtIron      , 2*U, Obsidian         ,18*U)                                                                          .aspects(TC.STRONTIO, 2).alloyCentrifuge(),
	Manyullyn               = alloymachine  ( 8703, "Manyullyn"                                     , 175, 100, 175, 255).put(MOLTEN).qual(2, 2.0,   96,  1)                                                                                                            .setMcfg( 0, Co             , 1*U, Ardite           , 1*U)                                                                                                  .aspects(TC.STRONTIO, 2).alloyCentrifuge(),
	VibraniumSteel          = slloymachine  ( 8704, "Vibranium Steel"                               ,  40,  24,  50, 255).put(CENTRIFUGE, MAGNETIC_PASSIVE).qual(3,   50.0, 2048, 10)                                                                                   .uumMcfg( 0, Vb             , 1*U, Steel            , 3*U)                                                                                                  .aspects(TC.SENSUS, 1, TC.VITREUS, 1, TC.METALLUM, 1).alloyCentrifuge().visDefault(Vb),
	VibraniumSilver         = slloy         ( 8705, "Vibranium Silver"                              , 240, 240, 255, 255).put(CENTRIFUGE, ENDER_DRAGON_PROOF).qual(3,  100.0,  512,  9)                                                                                 .uumMcfg( 0, Vb             , 1*U, Ag               , 3*U)                                                                                                  .aspects(TC.SENSUS, 1, TC.VITREUS, 1, TC.LUCRUM, 1).alloyCentrifuge().visDefault(Vb),
	Vibramantium            = slloymachine  ( 8706, "Vibramantium"                                  , 250, 250, 250, 255).put(CENTRIFUGE, MAGNETIC_PASSIVE).qual(3, 1000.0, 5120, 15)                                                                                   .uumMcfg( 0, Vb             , 1*U, Ad               , 3*U)                                                                                                  .aspects(TC.SENSUS, 1, TC.VITREUS, 1, TC.PRAECANTIO, 1, TC.METALLUM, 1).alloyCentrifuge().visDefault(Vb),
	Signalum                = alloymachine  ( 8708, "Signalum"                                      , 255,  64,   0, 255).put(MOLTEN, EXTRUDER_SIMPLE)                                                                                                         .uumMcfg( 8, Cu             , 1*U, Ag               , 2*U, RedAlloy         , 5*U)                                                                          .aspects(TC.METALLUM, 3, TC.POTENTIA, 1).alloyCentrifuge(),
	Lumium                  = slloymachine  ( 8709, "Lumium"                                        , 255, 255,  80, 255).put(MOLTEN, EXTRUDER_SIMPLE, LIGHTING, GLOWING)                                                                                      .uumMcfg( 4, Sn             , 3*U, Ag               , 1*U, Glowstone        , 4*U)                                                                          .aspects(TC.METALLUM, 3, TC.LUX, 1).alloyCentrifuge(),
	EnderiumBase            = alloymachine  ( 8729, "Enderium Base"                                 ,  53,  85, 108, 255).put(MOLTEN, MD.EIO)                                                                                                                           .uumMcfg( 4, Sn             , 2*U, Ag               , 1*U, Pt               , 1*U)                                                                          .aspects(TC.METALLUM, 3).alloyCentrifuge(),
	Enderium                = alloymachine  ( 8710, "Enderium"                                      ,  60, 125, 115, 255).put(MAGICAL, MOLTEN).qual(3,  8.0, 256, 3)                                                                                                    .setMcfg( 1, EnderiumBase   , 1*U, EnderPearl       , 1*U)                                                                                                  .aspects(TC.METALLUM, 3, TC.ALIENIS, 1).alloyCentrifuge(),
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60, 255).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                      ,
	FakeOsmium              = alloy         ( 8719, "Osmium"                                        , 160, 160, 255, 255).put(G_INGOT_MACHINE_ORES, MOLTEN, EXTRUDER_SIMPLE).setLocal("'Osmium'").steal(Os).qual(2, 6.0, 256, 2)                               .uumMcfg( 0, Os             , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.MACHINA, 2),
	RefinedGlowstone        = alloy         ( 8713, "GlowstoneRefined"      , SET_REDSTONE          , 255, 240, 100, 255).put("RefinedGlowstone", GLOWING).setLocal("Refined Glowstone").qual(2, 8.0, 256, 2)                                                           .setMcfg( 1, Glowstone      , 1*U)                                                                                                                          .aspects(TC.METALLUM, 4, TC.LUX, 4).setPulver(MT.Glowstone, U).setSmelting(MT.Glowstone, U),
	RefinedObsidian         = alloy         ( 8714, "ObsidianRefined"       , SET_REDSTONE          , 120,  90, 140, 255).put("RefinedObsidian").setLocal("Refined Obsidian").qual(2, 8.0, 512, 3)                                                                      .setMcfg( 1, Obsidian       , 1*U)                                                                                                                          .aspects(TC.VITREUS, 4, TC.IGNIS, 4).setPulver(MT.Obsidian, U).setSmelting(MT.Obsidian, U),
	Yellorium               = setalore      ( 8715, "Yellorium"                                     , 140, 130,  20, 255)                                                                                                                                                                                                                                                                                                           .aspects(TC.RADIO, 2),
	Blutonium               = setalore      ( 8716, "Blutonium"                                     ,  60,  60, 180, 255)                                                                                                                                                                                                                                                                                                           .aspects(TC.RADIO, 3),
	Cyanite                 = setalore      ( 8717, "Cyanite"                                       ,  50, 110, 150, 255)                                                                                                                                                                                                                                                                                                           .aspects(TC.RADIO, 1),
	Ludicrite               = setalore      ( 8723, "Ludicrite"                                     , 180, 120, 150, 255)                                                                                                                                                                                                                                                                                                           .aspects(TC.RADIO, 5),
	...
	PulsatingIron           = alloy         ( 8725, "Pulsating Iron"                                , 100, 160, 110, 255).put(MAGNETIC_PASSIVE, "PhasedIron").qual(WroughtIron)                                                                                         .setMcfg( 1, WroughtIron    , 1*U, EnderPearl       , 1*U)                                                                                                  .aspects(TC.METALLUM, 3, TC.ALIENIS, 1).setOriginalMod(MD.EIO).alloyCentrifuge(),
	ConductiveIron          = alloy         ( 8727, "Conductive Iron"                               , 170, 140, 140, 255).put(MAGNETIC_PASSIVE).qual(WroughtIron)                                                                                                       .uumMcfg( 1, WroughtIron    , 1*U, Redstone         , 1*U)                                                                                                  .aspects(TC.METALLUM, 3, TC.POTENTIA, 1).setOriginalMod(MD.EIO).alloyCentrifuge(),
	...
	VibrantAlloy            = slloy         ( 8726, "Vibrant Alloy"                                 , 160, 170,  70, 255).put("PhasedGold").qual(EnergeticAlloy)                                                                                                        .setMcfg( 1, EnergeticAlloy , 1*U, EnderPearl       , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.LUCRUM, 1, TC.LUX, 1, TC.ALIENIS, 1).setOriginalMod(MD.EIO).alloyCentrifuge(),
	ElectrumFlux            = slloy         ( 8711, "Electrum Flux"                                 , 255, 255, 120, 255).qual(3, 14.0, 64, 2)                                                                                                                          .uumMcfg( 1, Electrum       , 1*U, Redstone         , 2*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.PERMUTATIO, 2).alloyCentrifuge(),
	ElectricalSteel         = alloy         ( 8730, "Electrical Steel"                              , 140, 140, 140, 255).put(MAGNETIC_PASSIVE).qual(Steel)                                                                                                             .uumMcfg( 1, Steel          , 1*U, Si               , 1*U)                                                                                                  .aspects(TC.METALLUM, 3, TC.ELECTRUM, 1).setOriginalMod(MD.EIO).alloyCentrifuge(),
	ObsidianSteel           = alloy         ( 8731, "Obsidian Steel"                                ,  60,  60,  60, 255).put(MAGNETIC_PASSIVE, RAILS, "DarkSteel").qual(Steel)                                                                                         .setMcfg( 1, Steel          , 1*U, Obsidian         , 9*U)                                                                                                  .aspects(TC.METALLUM, 3, TC.TENEBRAE, 1).setOriginalMod(MD.TG).alloyCentrifuge(),
	...
	RedstoneAlloy           = alloy         ( 8733, "Redstone Alloy"                                , 140,  50,  50, 255).put(MOLTEN)                                                                                                                                   .uumMcfg( 1, Si             , 1*U, Redstone         , 1*U)                                                                                                  .aspects(TC.METALLUM, 3, TC.MACHINA, 1).setOriginalMod(MD.EIO).alloyCentrifuge().setPriorityPrefix(5),
	NikolineAlloy           = alloy         ( 8737, "Nikoline Alloy"                                ,  50,  90, 140, 255).put(MOLTEN)                                                                                                                                   .uumMcfg( 1, Si             , 1*U, Nikolite         , 1*U)                                                                                                  .aspects(TC.METALLUM, 3, TC.POTENTIA, 1).alloyCentrifuge().setPriorityPrefix(5),
	TeslatineAlloy          = alloy         ( 8738, "Teslatine Alloy"                               ,  50,  90, 140, 255).put(MOLTEN)                                                                                                                                   .uumMcfg( 1, Si             , 1*U, Teslatite        , 1*U)                                                                                                  .aspects(TC.METALLUM, 3, TC.POTENTIA, 1).alloyCentrifuge().setPriorityPrefix(5),
	...
	Manasteel               = slloymachine  ( 8720, "Manasteel"                                     , 110, 200, 250, 255).put(MAGICAL)                                                                                                                                                                                                                                                                                              .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 2).steal(Steel).qual(3, 12.0, 256, 3).heat(Fe.mMeltingPoint+ 500, Fe.mBoilingPoint+1000),
	Terrasteel              = slloymachine  ( 8721, "Terrasteel"                                    , 110, 200,  50, 255).put(MAGICAL)                                                                                                                                                                                                                                                                                              .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 2).steal(Steel).qual(3, 16.0,2048, 4).heat(Fe.mMeltingPoint+ 750, Fe.mBoilingPoint+1500),
	ElvenElementium         = slloymachore  ( 8722, "Elven Elementium"                              , 250, 120, 250, 255).put(MAGICAL)                                                                                                                                                                                                                                                                                              .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 2).steal(Steel).qual(3, 14.0, 512, 3).heat(Fe.mMeltingPoint+1000, Fe.mBoilingPoint+2000).setLocal("Elementium"),
	GaiaSpirit              = slloymachine  ( 8735, "Gaia Spirit"                                   , 250, 250, 250, 255).put(MAGICAL, GLOWING).qual(3, 20.0,2048, 4)                                                                                                                                                                                                                                                               .aspects(TC.AURAM, 4, TC.SPIRITUS, 4, TC.PRAECANTIO, 4).heat(W.mMeltingPoint+250, W.mBoilingPoint+500),
	Endium                  = metalore      ( 8736, "Endium"                                        ,  50,  10,  50, 255).put(MAGICAL).qual(3, 12.0, 256, 3)                                                                                                                                                                                                                                                                        .aspects(TC.METALLUM, 1, TC.ALIENIS, 3),
	Mauftrium               = slloymachore  ( 8739, "Mauftrium"                                     , 250, 225, 121, 255).put(MAGICAL).qual(3, 12.0,1024, 3)                                                                                                                                                                                                                                                                        .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 1).heat(Fe.mMeltingPoint, Fe.mBoilingPoint),
	Elvorium                = slloymachore  ( 8740, "Elvorium"                                      , 235, 164,  77, 255).put(MAGICAL).qual(3, 14.0,2048, 3)                                                                                                            .setMcfg( 1, ElvenElementium, 1*U, ElvenDragonstone , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 4).heat(Fe.mMeltingPoint+1000, Fe.mBoilingPoint+2000),
	NiflheimPower           = slloy         ( 8741, "Niflheim Power"                                ,  94,  94, 174, 255).put(MAGICAL, GLOWING, UNBURNABLE).qual(3, 18.0,2048, 3)                                                                                       .setMcfg( 1, Elvorium       , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.GELUM     , 2, TC.POTENTIA, 2),
	MuspelheimPower         = slloy         ( 8742, "Muspelheim Power"                              , 174,  94,  94, 255).put(MAGICAL, GLOWING, UNBURNABLE, BURNING).qual(3, 18.0,2048, 3)                                                                              .setMcfg( 1, Elvorium       , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.IGNIS     , 2, TC.POTENTIA, 2),
	Iffesal                 = oredust       ( 8743, "Iffesal"               , SET_SHINY             ,  14,  25, 171, 255).put(MAGICAL)                                                                                                                                                                                                                                                                                              .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 4),


	Desh                    = metalmachore  ( 8750, "Desh"                  , SET_DULL              ,  40,  40,  40, 255).qual(3,  4.0,   1280,  3)                                                                                                                                                                                                                                                                                 .aspects(TC.METALLUM, 2, TC.ALIENIS, 1, TC.TELUM, 1).heat(Steel),
	DuraniumAlloy           = alloymachine  ( 8751, "Duranium"                                      ,  75, 175, 175, 255).qual(3,  8.0,   1280,  4)                                                                                                                     .uumMcfg( 0, Dn             , 7*U, Mg               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 2).setOriginalMod(MD.MO).setLocal("Duranium Alloy").alloyCentrifuge(), // That Info with Magnesium/Magnesite was pretty hard to find, but I found it!
	TritaniumAlloy          = alloymachine  ( 8752, "Tritanium"                                     ,  55, 155, 155, 255).qual(3, 12.0,   2560,  5)                                                                                                                     .uumMcfg( 0, Tn             , 3*U, Dn               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 3, TC.VITREUS, 1).setOriginalMod(MD.MO).setLocal("Tritanium Alloy").alloyCentrifuge(),
	Dolamide                = oredust       ( 8753, "Dolamide"              , SET_METALLIC          , 188, 100, 122, 255)                                                                                                                                                                                                                                                                                                           .aspects(TC.POTENTIA, 3, TC.RADIO, 2),
	Oriharukon              = metalmachore  ( 8754, "Oriharukon"                                    , 220, 220, 240, 255).qual(3,  8.0,   2560,  2)                                                                                                                                                                                                                                                                                 .aspects(TC.METALLUM, 2, TC.MACHINA, 2),
	Adamantite              = metalmachore  ( 8755, "Adamantite"                                    , 255, 255, 190, 255).qual(3,  6.0,   2560,  3)                                                                                                                                                                                                                                                                                 .aspects(TC.METALLUM, 2, TC.TUTAMEN, 2),
	...
	Octine                  = metalmachore  ( 8786, "Octine"                                        , 255, 128,  32, 255).put(MOLTEN, MAGICAL, GLOWING, UNBURNABLE, BURNING)                                                                                                                                                                                                                                                        .aspects(TC.METALLUM, 2, TC.MORTUUS, 1).qual(3, 8.0,  900, 2).heat(Steel.mBoilingPoint-200, Steel.mBoilingPoint+500),


	HSSG                    = alloymachine  ( 8796, "HSS-G"                                         , 153, 153,   0, 255).put(MOLTEN).qual(3, 10.0F, 4000, 3)                                                                                                           .uumMcfg( 0, TungstenSteel  , 5*U, Cr               , 1*U, Mo               , 2*U, V                , 1*U)                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 1, TC.MACHINA, 1).alloyCentrifuge(),
	HSSE                    = alloymachine  ( 8797, "HSS-E"                                         ,  51, 102,   0, 255).put(MOLTEN).qual(3, 10.0F, 5120, 4)                                                                                                           .uumMcfg( 0, HSSG           , 6*U, Co               , 1*U, Mn               , 1*U, Si               , 1*U)                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 2, TC.MACHINA, 2).alloyCentrifuge(),
	HSSS                    = alloymachine  ( 8798, "HSS-S"                                         , 102,   0,  51, 255).put(MOLTEN).qual(3, 14.0F, 3000, 4)                                                                                                           .uumMcfg( 0, HSSG           , 6*U, Osmiridium       , 2*U, Ir               , 1*U)                                                                          .aspects(TC.METALLUM, 2, TC.TUTAMEN, 2, TC.MACHINA, 2, TC.NEBRISUM, 1).alloyCentrifuge(),


	Bedrockium              = metalmachore  ( 8795, "Bedrockium"            , SET_ROUGH             ,  88,  88,  88, 255).put(WITHER_PROOF, ENDER_DRAGON_PROOF).qual(3, 14.0F, 3000, 4)                                                                                                                                                                                                                                                                   .aspects(TC.METALLUM, 1, TC.TERRA, 10).heat(2000),


	Draconium               = metalmachore  ( 8791, "Draconium"                                     , 150,  50, 250, 255).qual(3, 16.0F,  5000, 4).put(MOLTEN, WITHER_PROOF, ENDER_DRAGON_PROOF)                                                                                                                                                                                                                                    .aspects(TC.METALLUM, 2, TC.ALIENIS, 1).heat(4500),
	DraconiumAwakened       = alloymachine  ( 8792, "DraconiumAwakened"                             , 250, 150,  50, 255).qual(3, 24.0F, 10000, 5).put(MOLTEN, WITHER_PROOF, ENDER_DRAGON_PROOF, GLOWING)                                                               .setMcfg( 1, Draconium      , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.ALIENIS, 4).heat(5500).setLocal("Awakened Draconium"),


	CrystalMatrix           = slloymachine  ( 8799, "Crystal Matrix"                                ,  83, 231, 234, 255).qual(3,        20.0,     25600,  4).put(VALUABLE, UNBURNABLE, MAGICAL, WITHER_PROOF, ENDER_DRAGON_PROOF)                                      .setMcfg( 1, Diamond        ,20*U, NetherStar       , 2*U)                                                                                                  .aspects(TC.VITREUS, 8, TC.PRAECANTIO, 4, TC.NEBRISUM, 4).heat(3896, 5127),
	CosmicNeutronium        = setalmachine  ( 8800, "Cosmic Neutronium"                             ,  30,  10,  40, 255).qual(3,        50.0,    100000, 10).put(VALUABLE, UNBURNABLE, MAGICAL, WITHER_PROOF, ENDER_DRAGON_PROOF)                                                                                                                                                                                                  .aspects(TC.POTENTIA, 10, TC.NEBRISUM, 10, TC.RADIO, 10, TC.TENEBRAE, 10, TC.TERRA, 10).heat(100000),
	Infinity                = setalmachine  ( 8801, "Infinity"                                      , 250, 250, 250, 255).qual(3,1000000000.0,1000000000, 15).put(VALUABLE, UNBURNABLE, MAGICAL, WITHER_PROOF, ENDER_DRAGON_PROOF, GLOWING, LIGHTING, MAGNETIC_ACTIVE)                                                                                                                                                              .aspects(TC.POTENTIA, 10, TC.NEBRISUM, 10, TC.PERMUTATIO, 10, TC.MAGNETO, 10, TC.PRAECANTIO, 10, TC.AURAM, 10).heat(100000),


	Trinaquadalloy          = alloymachine  ( 8684, "Trinaquadalloy"                                , 146, 186, 146, 255).put(CENTRIFUGE, "NaquadahAlloy").qual(3, 14.0,  20480,  5)                                                                                    .uumMcfg( 0, Ke             , 6*U, Nq               , 2*U, C                , 1*U)                                                                          .aspects(TC.METALLUM, 3, TC.TUTAMEN, 3, TC.NEBRISUM, 1).alloyCentrifuge(),
	Trinitanium             = alloymachine  ( 8790, "Trinitanium"                                   , 235, 175, 255, 255).qual(3, 16.0,   5120,  4)                                                                                                                     .uumMcfg( 0, Ke             , 2*U, Ti               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 2, TC.VITREUS, 2).alloyCentrifuge(),


	Iritanium               = alloymachine  ( 8793, "Titanium Iridium"                              , 220, 220, 255, 255).put("Iritanium").qual(3,  8.0,   7680,  4)                                                                                                    .uumMcfg( 0, Ir             , 1*U, Ti               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 1, TC.MACHINA, 1).alloyCentrifuge().setLocal("Iritanium"),
	TitaniumAluminide       = alloymachine  ( 8794, "Titanium Aluminide"                            , 200, 200, 255, 255).qual(3, 12.0,   3840,  3)                                                                                                                     .uumMcfg( 3, Ti             , 3*U, Al               , 7*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 1, TC.VOLATUS, 1).alloyCentrifuge(),

	/*
	 * 31000 - 32000 for GT6U
	 * */
	RhodiumPlatedPalladium                = alloymachine  ( 31000, "Rhodium-Plated Palladium"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER).qual(3,  6.5,    96,  2)                                                                        .uumMcfg( 0, Pd             , 3*U, Rh      , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.FABRICO, 1).alloyCentrifuge(),
	BlackPlutonium                = alloymachine  ( 31001, "Black Plutonium"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorULV                = alloymachine  ( 31002, "Superconductor Base ULV"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorLV                = alloymachine  ( 31003, "Superconductor Base LV"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorMV                = alloymachine  ( 31004, "Superconductor Base MV"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorHV                = alloymachine  ( 31005, "Superconductor Base HV"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorEV                = alloymachine  ( 31006, "Superconductor Base EV"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorIV                = alloymachine  ( 31007, "Superconductor Base IV"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorLuV                = alloymachine  ( 31008, "Superconductor Base LuV"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorZPM                = alloymachine  ( 31009, "Superconductor Base ZPM"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorUV                = alloymachine  ( 31010, "Superconductor Base UV"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorPUV1                = alloymachine  ( 31011, "Superconductor Base PUV1"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorPUV2                = alloymachine  ( 31012, "Superconductor Base PUV2"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorPUV3                = alloymachine  ( 31013, "Superconductor Base PUV3"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorPUV4                = alloymachine  ( 31014, "Superconductor Base PUV4"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorPUV5                = alloymachine  ( 31015, "Superconductor Base PUV5"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorOmega                = alloymachine  ( 31016, "Superconductor Base Omega"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
	SuperconductorMAX                = alloymachine  ( 31017, "Superconductor Base MAX"      , 200, 200, 200, 255).put(MORTAR, MOLTEN, EXTRUDER).qual(3,  6.5,    96,  2)  .aspects(TC.METALLUM, 2, TC.FABRICO, 1)
	...
	public static class TECH {
		...
		static {
			 ...
			 * GT6 Unofficial
			 * */
			RhodiumPlatedPalladium.put(MD.GT);
			BlackPlutonium.put(MD.GT);
...
//          Al                      .addAlloyingRecipe(new OreDictConfigurationComponent( 1, OM.stack(OREMATS.Bauxite               , 2*U), OM.stack(K                  , 1*U)));
	...
	public static class DATA {
		...
		//Machine_T[] = { Pb, Bi, Bronze, Invar, ANY.Steel, Ta4HfC5, Al, StainlessSteel, Ti, ANY.W, TungstenSteel, HSSG, RhodiumPlatedPalladium, Ir, Os, HSSS, Neutronium, Bedrockium, BlackPlutonium, Draconium, CrystalMatrix, CosmicNeutronium, Infinity};

		public static final OreDictItemData[]
		WIRES_01 = {
			OP.wireGt01.dat(Wire_T[0]),
			OP.wireGt01.dat(Wire_T[1]),
			OP.wireGt01.dat(Wire_T[2]),
			OP.wireGt01.dat(Wire_T[3]),
			OP.wireGt01.dat(Wire_T[4]),
			OP.wireGt01.dat(Wire_T[5]),
			OP.wireGt01.dat(Wire_T[6]),
			OP.wireGt01.dat(Wire_T[7]),
			OP.wireGt01.dat(Wire_T[8]),
			OP.wireGt01.dat(Wire_T[9]),
			OP.wireGt01.dat(Wire_T[10]),
			OP.wireGt01.dat(Wire_T[11]),
			OP.wireGt01.dat(Wire_T[12]),
			OP.wireGt01.dat(Wire_T[13]),
			OP.wireGt01.dat(Wire_T[14]),
			OP.wireGt01.dat(Wire_T[15])
		},
		WIRES_04 = {
			OP.wireGt04.dat(Wire_T[0]),
			OP.wireGt04.dat(Wire_T[1]),
			OP.wireGt04.dat(Wire_T[2]),
			OP.wireGt04.dat(Wire_T[3]),
			OP.wireGt04.dat(Wire_T[4]),
			OP.wireGt04.dat(Wire_T[5]),
			OP.wireGt04.dat(Wire_T[6]),
			OP.wireGt04.dat(Wire_T[7]),
			OP.wireGt04.dat(Wire_T[8]),
			OP.wireGt04.dat(Wire_T[9]),
			OP.wireGt04.dat(Wire_T[10]),
			OP.wireGt04.dat(Wire_T[11]),
			OP.wireGt04.dat(Wire_T[12]),
			OP.wireGt04.dat(Wire_T[13]),
			OP.wireGt04.dat(Wire_T[14]),
			OP.wireGt04.dat(Wire_T[15])
		},
		CABLES_01 = {
			OP.cableGt01.dat(Wire_T[0]),
			OP.cableGt01.dat(Wire_T[1]),
			OP.cableGt01.dat(Wire_T[2]),
			OP.cableGt01.dat(Wire_T[3]),
			OP.cableGt01.dat(Wire_T[4]),
			OP.cableGt01.dat(Wire_T[5]),
			OP.cableGt01.dat(Wire_T[6]),
			OP.cableGt01.dat(Wire_T[7]),
			OP.cableGt01.dat(Wire_T[8]),
			OP.cableGt01.dat(Wire_T[9]),
			OP.cableGt01.dat(Wire_T[10]),
			OP.cableGt01.dat(Wire_T[11]),
			OP.cableGt01.dat(Wire_T[12]),
			OP.cableGt01.dat(Wire_T[13]),
			OP.cableGt01.dat(Wire_T[14]),
			OP.cableGt01.dat(Wire_T[15])
		},
		CABLES_04 = {
			OP.cableGt04.dat(Wire_T[0]),
			OP.cableGt04.dat(Wire_T[1]),
			OP.cableGt04.dat(Wire_T[2]),
			OP.cableGt04.dat(Wire_T[3]),
			OP.cableGt04.dat(Wire_T[4]),
			OP.cableGt04.dat(Wire_T[5]),
			OP.cableGt04.dat(Wire_T[6]),
			OP.cableGt04.dat(Wire_T[7]),
			OP.cableGt04.dat(Wire_T[8]),
			OP.cableGt04.dat(Wire_T[9]),
			OP.cableGt04.dat(Wire_T[10]),
			OP.cableGt04.dat(Wire_T[11]),
			OP.cableGt04.dat(Wire_T[12]),
	...
	public static class OREMATS {
		...
		Cassiterite             = oredustelec   ( 9108, "Cassiterite"               , SET_METALLIC          , 220, 220, 220, 255).put(MORTAR, "CassiteriteSand"                                        ).setSmelting(Sn, 3*U4)     .uumMcfg( 1, Sn             , 1*U, O                , 2*U)                                                                                                  .heat(3 * Sn.mMeltingPoint / 2), CassiteriteSand = Cassiterite,
//      CassiteriteSand         = oredustelec   ( 9109, "Cassiterite Sand"          , SET_SAND              , 220, 220, 220, 255).put(MORTAR, FURNACE                                                           ).setSmelting(Sn, 3*U4)     .uumMcfg( 1, Sn             , 1*U, O                , 2*U)                                                                                                  .heat(3 * Sn.mMeltingPoint / 2),
		Garnierite              = oredustelec   ( 9118, "Garnierite"                , SET_METALLIC          ,  50, 200,  70, 255).put(MORTAR, BLACKLISTED_SMELTER, MAGNETIC_PASSIVE, WASHING_PERSULFATE         ).setSmelting(Ni, 3*U4)     .uumMcfg( 1, Ni             , 1*U, O                , 1*U)                                                                                                  .qual(0, 1.0, 16, 0),
		...
		Cinnabar                = oredustcent   ( 9114, "Cinnabar"                  , SET_ROUGH             , 150,   0,   0, 255).put(MORTAR                                                           ).setSmelting(Hg,   U3)     .uumMcfg( 0, Hg             , 1*U, S                , 1*U)                                                                                                  ,
		...
		Pentlandite             = oredustdcmp   ( 9145, "Pentlandite"               , SET_DULL              , 165, 150,   5, 255).put(MORTAR, BLACKLISTED_SMELTER, MAGNETIC_PASSIVE, WASHING_PERSULFATE         ).setSmelting(Ni,   U3)     .uumMcfg( 0, Ni             , 9*U, S                , 8*U)                                                                                                  .qual(0, 1.0, 16, 0), // (Fe,Ni)9S8
		Chalcopyrite            = oredustdcmp   ( 9111, "Chalcopyrite"              , SET_DULL              , 160, 120,  40, 255).put(MORTAR                                                           ).setSmelting(Cu, 2*U9)     .uumMcfg( 0, Cu             , 1*U, Fe               , 1*U, S                , 2*U)                                                                          .qual(0, 1.0, 16, 0),
		...
		Cobaltite               = oredustdcmp   ( 9115, "Cobaltite"                 , SET_METALLIC          ,  80,  80, 250, 255).put(MORTAR, BLACKLISTED_SMELTER, MAGNETIC_PASSIVE, WASHING_PERSULFATE         ).setSmelting(Co,   U4)     .uumMcfg( 0, Co             , 1*U, As               , 1*U, S                , 1*U)                                                                          .qual(0, 1.0, 16, 0),
		Galena                  = oredustdcmp   ( 9117, "Galena"                    , SET_DULL              , 100,  60, 100, 255).put(MORTAR                                                           ).setSmelting(Pb,   U3)     .uumMcfg( 0, Pb             , 3*U, Ag               , 3*U, S                , 2*U)                                                                          ,
		...
		Tetrahedrite            = oredustdcmp   ( 9132, "Tetrahedrite"              , SET_DULL              , 200,  32,   0, 255).put(MORTAR, WASHING_PERSULFATE                                       ).setSmelting(Cu,   U4)     .uumMcfg( 0, Cu             , 3*U, Sb               , 1*U, Fe               , 1*U, S                , 3*U)                                                  , // Cu3SbS3 + x(Fe,Zn)6Sb2S9
		...
		Scheelite               = oredustdcmp   ( 9128, "Scheelite"                 , SET_DULL              , 200, 140,  20, 255).put(BLACKLISTED_SMELTER, "CalciumTungstate"                                   )                           .uumMcfg( 0, Ca             , 1*U, WO3              , 4*U, O                , 1*U)                                                                          .qual(0, 1.0, 16, 3),
		Wolframite              = oredustdcmp   ( 9217, "Wolframite"                , SET_DULL              ,  55,  50,  35, 255).put(BLACKLISTED_SMELTER                                                       )                           .uumMcfg( 0, Mg             , 1*U, WO3              , 4*U, O                , 1*U)                                                                          .qual(0, 1.0, 16, 3),
		Ferberite               = oredustdcmp   ( 9194, "Ferberite"                 , SET_DULL              ,  55,  50,  35, 255).put(BLACKLISTED_SMELTER                                                       )                           .uumMcfg( 0, Fe             , 1*U, WO3              , 4*U, O                , 1*U)                                                                          .qual(0, 1.0, 16, 3),
		Huebnerite              = oredustdcmp   ( 9195, "Huebnerite"                , SET_DULL              ,  55,  50,  35, 255).put(BLACKLISTED_SMELTER, "Gyubnera"                                           )                           .uumMcfg( 0, Mn             , 1*U, WO3              , 4*U, O                , 1*U)                                                                          .qual(0, 1.0, 16, 3),
		Tungstate               = oredustdcmp   ( 9133, "Tungstate"                 , SET_DULL              ,  55,  50,  35, 255).put(BLACKLISTED_SMELTER                                                       )                           .uumMcfg( 0, Li             , 2*U, WO3              , 4*U, O                , 1*U)                                                                          .qual(0, 1.0, 16, 3),

		Stolzite                = oredustdcmp   ( 9193, "Stolzite"                  , SET_DULL              ,  55,  50,  35, 255).put(BLACKLISTED_SMELTER, "Raspite"                                            ).setSmelting(WO3,4* U6)    .uumMcfg( 0, Pb             , 1*U, WO3              , 4*U, O                , 1*U)                                                                          .qual(0, 1.0, 16, 3), // TODO Actual Processing, but I don't know what could do it
		Russellite              = oredustdcmp   ( 9196, "Russellite"                , SET_DULL              ,  55,  50,  35, 255).put(BLACKLISTED_SMELTER                                                       ).setSmelting(WO3,4* U9)    .setMcfg( 0, Bi             , 2*U, WO3              , 4*U, O                , 3*U)                                                                          .qual(0, 1.0, 16, 3), // TODO Actual Processing, but I don't know what could do it
		Pinalite                = oredustdcmp   ( 9197, "Pinalite"                  , SET_DULL              ,  55,  50,  35, 255).put(BLACKLISTED_SMELTER                                                       ).setSmelting(WO3,4*U11)    .uumMcfg( 0, Pb             , 3*U, WO3              , 4*U, Cl               , 2*U, O                , 2*U)                                                  .qual(0, 1.0, 16, 3), // TODO Actual Processing, but I don't know what could do it
		...
		Malachite               = oredustelec   ( 9156, "Malachite"                 , SET_LAPIS             ,   5,  95,   5, 255).put(MORTAR, G_GEM_ORES, WASHING_PERSULFATE                           ).setSmelting(Cu,   U6)     .setMcfg( 0, Cu             , 2*U, C                , 1*U, H2O              , 3*U, O                , 4*U)                                                  , // Cu2CO3(OH)2
	...
	public static class UNUSED {
		...
		Dark                   = unused        ("Dark Stone"                   ).put(G_DUST),
