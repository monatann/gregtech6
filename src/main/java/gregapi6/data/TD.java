...
public class TD {
	...
	public static class Energy {
		 ...
		 */
		public static final TagData STEAM                                   = TagData.createTagData("ENERGY.GT6STEAM", "GT6Steam", "GT6Steam", LH.Chat.GRAY);
	...
	public static class ItemGenerator {
		...
		G_CRYSTAL                   = new TagData[] {DUSTS, PLANTS, GEMS},
		G_CRYSTAL_ORES              = new TagData[] {DUSTS, PLANTS, GEMS, ORES},
		...
		G_QUARTZ_ORES               = new TagData[] {DUSTS, PLANTS, PLATES, PROJECTILES, STICKS, GEMS, ORES},
		G_GEM                       = new TagData[] {DUSTS, PLANTS, PLATES, PROJECTILES, STICKS, GEMS, ARMORS},
		G_GEM_ORES                  = new TagData[] {DUSTS, PLANTS, PLATES, PROJECTILES, STICKS, GEMS, ARMORS, ORES},
		G_GEM_TRANSPARENT           = new TagData[] {DUSTS, PLANTS, PLATES, PROJECTILES, STICKS, GEMS, ARMORS, LENSES, TD.Properties.TRANSPARENT},
		G_GEM_ORES_TRANSPARENT      = new TagData[] {DUSTS, PLANTS, PLATES, PROJECTILES, STICKS, GEMS, ARMORS, LENSES, TD.Properties.TRANSPARENT, ORES},
		G_WOOD                      = new TagData[] {DUSTS, PLANTS, PLATES, PROJECTILES, STICKS, FOILS},
		G_STONE                     = new TagData[] {DUSTS, PLANTS, PLATES, PROJECTILES, STICKS, DIRTY_DUSTS},
		G_BRICK                     = new TagData[] {DUSTS, PLANTS, PLATES, PROJECTILES, STICKS, INGOTS},
		G_INGOT                     = new TagData[] {DUSTS, PLANTS, PLATES, PROJECTILES, STICKS, ARMORS, INGOTS, INGOTS_HOT, MULTIINGOTS, DENSEPLATES, MULTIPLATES, FOILS},
		G_INGOT_ORES                = new TagData[] {DUSTS, PLANTS, PLATES, PROJECTILES, STICKS, ARMORS, INGOTS, INGOTS_HOT, MULTIINGOTS, DENSEPLATES, MULTIPLATES, FOILS, ORES},
		G_INGOT_MACHINE             = new TagData[] {DUSTS, PLANTS, PLATES, PROJECTILES, STICKS, ARMORS, INGOTS, INGOTS_HOT, MULTIINGOTS, DENSEPLATES, MULTIPLATES, FOILS, PARTS},
		G_INGOT_MACHINE_ORES        = new TagData[] {DUSTS, PLANTS, PLATES, PROJECTILES, STICKS, ARMORS, INGOTS, INGOTS_HOT, MULTIINGOTS, DENSEPLATES, MULTIPLATES, FOILS, PARTS, ORES},
		G_INGOT_ND                  = new TagData[] {PLATES, PROJECTILES, STICKS, ARMORS, INGOTS, INGOTS_HOT, MULTIINGOTS, DENSEPLATES, MULTIPLATES, FOILS},
		G_INGOT_ND_MACHINE          = new TagData[] {PLATES, PROJECTILES, STICKS, ARMORS, INGOTS, INGOTS_HOT, MULTIINGOTS, DENSEPLATES, MULTIPLATES, FOILS, PARTS},
		G_MACHINE                   = new TagData[] {PLATES, PROJECTILES, STICKS, ARMORS, WIRES, FOILS, PARTS};
	}
}
