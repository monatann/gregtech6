...
import gregapi6.data.TC.TC_AspectStack;
...
public class UT {
	...
	public static class NBT {
		...
		public static NBTTagCompound setBlueprintCrafting(NBTTagCompound aNBT, ItemStack... aBlueprint) {
			...
			if (temp) aNBT.setTag("gt6.blueprint.craft", tList);
			return aNBT;
		}
		public static ItemStack[] getBlueprintCrafting(NBTTagCompound aNBT) {
			NBTTagCompound tList = aNBT.hasKey("gt6.blueprint.craft")?aNBT.getCompoundTag("gt6.blueprint.craft"):null;
			if (tList != null) {
