...
public class GT_API_Proxy_Client extends GT_API_Proxy {
	...
	public void onProxyBeforeInit(Abstract_Mod aMod, FMLInitializationEvent aEvent) {
		for (OreDictMaterial tMaterial : OreDictMaterial.MATERIAL_MAP.values()) LH.add("gt6.material." + tMaterial.mNameInternal, tMaterial.mNameLocal);
	}
	...
	public void onItemTooltip(ItemTooltipEvent aEvent) {
		...
		if (UT.NBT.getNBT(aEvent.itemStack).getBoolean("gt6.err.oredict.output")) {
