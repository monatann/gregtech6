...
public class MultiTileEntityWireRedstoneInsulated extends TileEntityBase10ConnectorRendered implements ITileEntityQuickObstructionCheck, ITileEntityRedstoneWire, ITileEntityProgress, ITileEntitySwitchableMode, IMTE_GetComparatorInputOverride {
	...
	public void readFromNBT2(NBTTagCompound aNBT) {
		...
		if (aNBT.hasKey("gt6.mreceived")) mReceived = aNBT.getByte("gt6.mreceived");
		if (aNBT.hasKey("gt6.mredstone")) mRedstone = aNBT.getByte("gt6.mredstone");
	...
	public void writeToNBT2(NBTTagCompound aNBT) {
		...
		aNBT.setByte("gt6.mreceived", mReceived);
		UT.NBT.setNumber(aNBT, "gt6.mredstone", mRedstone);
	}
	...
	@Override public String getTileEntityName               () {return "gt6.multitileentity.connector.wire.redstone.insulated";}
}
