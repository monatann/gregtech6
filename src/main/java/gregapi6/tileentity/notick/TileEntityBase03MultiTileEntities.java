...
import gregapi6.block.multitileentity.IMultiTileEntity.IMTE_GetDrops;
import gregapi6.block.multitileentity.IMultiTileEntity.IMTE_GetPickBlock;
import gregapi6.block.multitileentity.IMultiTileEntity.IMTE_GetStackFromBlock;
import gregapi6.block.multitileentity.IMultiTileEntity.IMTE_OnBlockActivated;
import gregapi6.block.multitileentity.IMultiTileEntity.IMTE_OnPainting;
import gregapi6.block.multitileentity.IMultiTileEntity.IMTE_OnRegistrationFirst;
import gregapi6.block.multitileentity.IMultiTileEntity.IMTE_RecolourBlock;
import gregapi6.block.multitileentity.IMultiTileEntity.IMTE_ShouldSideBeRendered;
import gregapi6.block.multitileentity.MultiTileEntityClassContainer;
...
public abstract class TileEntityBase03MultiTileEntities extends TileEntityBase02Sync implements IRenderedBlockObjectSideCheck, IRenderedBlockObject, IMTE_OnPainting, IMTE_GetPickBlock, IMTE_GetStackFromBlock, IMTE_OnRegistrationFirst, IMTE_RecolourBlock, IMTE_GetDrops, IMTE_OnBlockActivated, IMTE_ShouldSideBeRendered {
	...
	/** return the internal Name of this TileEntity to be registered. DO NOT START YOUR NAME WITH "gt6."!!! */
