...
import gregapi6.block.multitileentity.IMultiTileEntity.IMTE_GetFireSpreadSpeed;
import gregapi6.block.multitileentity.IMultiTileEntity.IMTE_GetFlammability;
 ...
 */
public abstract class TileEntityBase05Paintable extends TileEntityBase04Covers implements IItemColorableRGB, ITileEntityDecolorable, IMTE_GetSubItems, IMTE_GetExplosionResistance, IMTE_GetBlockHardness, IMTE_SyncDataByte, IMTE_SyncDataByteArray, IMTE_GetFlammability, IMTE_GetFireSpreadSpeed, IMTE_GetLightOpacity {
	...
	public IPacket getClientDataPacket(boolean aSendAll) {
		return aSendAll ? getClientDataPacketByteArray(aSendAll, (byte)UT.Code.getR(mRGBa), (byte)UT.Code.getG(mRGBa), (byte)UT.Code.getB(mRGBa), getVisualData()) : super.getClientDataPacketByte(aSendAll, getVisualData());
	}
	...
	@Override public boolean removePaint(byte aSide) {return unpaint();}
