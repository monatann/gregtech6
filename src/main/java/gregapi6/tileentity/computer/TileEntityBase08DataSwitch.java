...
package gregapi6.tileentity.computer;
...
public abstract class TileEntityBase08DataSwitch extends TileEntityBase07Paintable implements IMTE_AddToolTips, ITileEntityUSBPort, ITileEntitySwitchableMode {
	...
	static {
		LH.add("gt6.multitileentity.data.switch.tooltip.1", "Use adjacent to Machines that require USB Sticks to select Recipes");
		LH.add("gt6.multitileentity.data.switch.tooltip.2", "Add USB Cable to Slot where USB Stick in the Recipe would go");
		LH.add("gt6.multitileentity.data.switch.tooltip.3", "Clicking with USB Stick will write its Data to the selected Slot.");
		LH.add("gt6.multitileentity.data.switch.tooltip.4", "Not usable with Machines that consume USB Sticks, such as Scanners!");
		LH.add("gt6.multitileentity.data.switch.tooltip.5", "Requires a Selector Cover to work, otherwise it always selects Slot 0!");
	}
	
	@Override
	public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
		aList.add(Chat.CYAN + LH.get("gt6.multitileentity.data.switch.tooltip.1"));
		aList.add(Chat.CYAN + LH.get("gt6.multitileentity.data.switch.tooltip.2"));
		aList.add(Chat.CYAN + LH.get("gt6.multitileentity.data.switch.tooltip.3"));
		aList.add(Chat.ORANGE + LH.get("gt6.multitileentity.data.switch.tooltip.4"));
		aList.add(Chat.ORANGE + LH.get("gt6.multitileentity.data.switch.tooltip.5"));
	}
