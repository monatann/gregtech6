...
import gregapi6.tileentity.ITileEntityRemoteActivateable;
...
public class Behavior_Remote extends AbstractBehaviorDefault {
	...
	public ArrayListNoNulls<ChunkCoordinates> getCoordinateList(NBTTagCompound aNBT, int aDimension) {
		...
		NBTTagCompound tNBT = aNBT.getCompoundTag("gt6.remote.dim."+aDimension);
	...
	public void setCoordinateList(NBTTagCompound aNBT, int aDimension, ArrayListNoNulls<ChunkCoordinates> aList) {
		...
		aNBT.setTag("gt6.remote.dim."+aDimension, tNBT);
		if (tNBT.hasNoTags()) aNBT.removeTag("gt6.remote.dim."+aDimension);
	}
	
	static {
		LH.add("gt6.behaviour.remote", "Activates up to 16 Blocks within a Range of 128m");
	}
	
	@Override
	public List<String> getAdditionalToolTips(MultiItem aItem, List<String> aList, ItemStack aStack) {
		aList.add(LH.get("gt6.behaviour.remote"));
		return aList;
	}
}
