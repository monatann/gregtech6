...
public class MultiTileEntityMiniPortalTropics extends MultiTileEntityMiniPortal {
	...
	static {
		LH.add("gt6.tileentity.portal.tropic.tooltip.1", "Only works between the Tropics and the Overworld!");
		LH.add("gt6.tileentity.portal.tropic.tooltip.2", "Margin of Error to still work: 128 Meters.");
		LH.add("gt6.tileentity.portal.tropic.tooltip.3", "Requires any Tropicraft Cocktail for activation");
	}
	
	@Override
	public void addToolTips2(List<String> aList, ItemStack aStack, boolean aF3_H) {
		aList.add(Chat.CYAN     + LH.get("gt6.tileentity.portal.tropic.tooltip.1"));
		aList.add(Chat.CYAN     + LH.get("gt6.tileentity.portal.tropic.tooltip.2"));
		aList.add(Chat.ORANGE   + LH.get("gt6.tileentity.portal.tropic.tooltip.3"));
	}
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.portal.tropics";}
}
