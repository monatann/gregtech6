...
import gregapi6.block.multitileentity.IMultiTileEntity.IMTE_RandomDisplayTick;
...
public class MultiTileEntityMiniPortalNether extends MultiTileEntityMiniPortal implements IMTE_RandomDisplayTick {
	...
	static {
		LH.add("gt6.tileentity.portal.nether.tooltip.1", "Only works between the Nether and the Overworld with a x8 Distance Factor!");
		LH.add("gt6.tileentity.portal.nether.tooltip.2", "Margin of Error to still work: 128 Meters.");
	}
	
	@Override
	public void addToolTips2(List<String> aList, ItemStack aStack, boolean aF3_H) {
		aList.add(Chat.CYAN     + LH.get("gt6.tileentity.portal.nether.tooltip.1"));
		aList.add(Chat.CYAN     + LH.get("gt6.tileentity.portal.nether.tooltip.2"));
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.portal.nether";}
}
