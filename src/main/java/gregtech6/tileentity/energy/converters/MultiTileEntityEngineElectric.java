...
public class MultiTileEntityEngineElectric extends TileEntityBase09FacingSingle implements ITileEntityAdjacentOnOff, ITileEntityEnergyFluxHandler, ITileEntityEnergyElectricityAcceptor, ITileEntityRunningActively, ITileEntitySwitchableMode {
	...
	public ITexture getTexture2(Block aBlock, int aRenderPass, byte aSide, boolean[] aShouldSideBeRendered) {
		...
		case 3: return aSide==OPPOSITES [mFacing]?null:BlockTextureMulti.get(BlockTextureDefault.get(sColoreds[4], sEngineColors[mState]), BlockTextureDefault.get(sOverlays[4]));
	...
	public static IIconContainer sColoreds[] = new IIconContainer[] {
		...
		new Textures.BlockIcons.CustomIcon("machines/engines/kinetic_electric/overlay/cage"),
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.engine.kinetic_electricity";}
}
