...
public class MultiTileEntityEnderGarbageBin extends TileEntityBase07Paintable implements IFluidHandler, ITileEntityFunnelAccessible, IMTE_AddToolTips {
	static {
		LH.add("gt6.multitileentity.ender.garbage.bin.tooltip.1", "Trash Bin deleting Items & Fluids, or moving them to the Servers Garbage Dump");
		LH.add("gt6.multitileentity.ender.garbage.bin.tooltip.2", "Items & Fluids entering this will be dumped inside the Garbage Dimension");
		LH.add("gt6.multitileentity.ender.garbage.bin.tooltip.3", "You can stop this from operating using a simple Redstone Signal");
	}
	
	@Override
	public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
		aList.add(Chat.CYAN + LH.get("gt6.multitileentity.ender.garbage.bin.tooltip.1"));
		aList.add(Chat.CYAN + LH.get("gt6.multitileentity.ender.garbage.bin.tooltip.2"));
		aList.add(Chat.CYAN + LH.get("gt6.multitileentity.ender.garbage.bin.tooltip.3"));
	}
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.ender.garbage.bin";}
