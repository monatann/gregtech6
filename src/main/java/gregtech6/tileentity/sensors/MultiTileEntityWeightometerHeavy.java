...
public class MultiTileEntityWeightometerHeavy extends MultiTileEntitySensorTE {
	static {LH.add("gt6.tooltip.sensor.heavyweightometer", "Measures the weight of an Inventory (in Tons)");}
	@Override public String getSensorDescription() {return LH.get("gt6.tooltip.sensor.heavyweightometer");}
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.redstone.sensors.heavyweightometer";}
}
