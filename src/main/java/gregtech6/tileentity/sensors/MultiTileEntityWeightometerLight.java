...
public class MultiTileEntityWeightometerLight extends MultiTileEntitySensorTE {
	static {LH.add("gt6.tooltip.sensor.lightweightometer", "Measures the weight of an Inventory (in Gramm)");}
	@Override public String getSensorDescription() {return LH.get("gt6.tooltip.sensor.lightweightometer");}
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.redstone.sensors.lightweightometer";}
}
