...
public class MultiTileEntityItemometer extends MultiTileEntitySensorTE {
	static {LH.add("gt6.tooltip.sensor.itemometer", "Measures the precise amount of Items");}
	@Override public String getSensorDescription() {return LH.get("gt6.tooltip.sensor.itemometer");}
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.redstone.sensors.itemometer";}
}
