...
public class MultiTileEntityBucketometer extends MultiTileEntitySensorTE {
	static {LH.add("gt6.tooltip.sensor.bucketometer", "Measures Fluids (In Cubic Meters)");}
	@Override public String getSensorDescription() {return LH.get("gt6.tooltip.sensor.bucketometer");}
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.redstone.sensors.bucketometer";}
}
