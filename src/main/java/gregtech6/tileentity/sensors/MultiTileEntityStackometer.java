...
public class MultiTileEntityStackometer extends MultiTileEntitySensorTE {
	static {LH.add("gt6.tooltip.sensor.stackometer", "Measures the precise amount of Stacks");}
	@Override public String getSensorDescription() {return LH.get("gt6.tooltip.sensor.stackometer");}
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.redstone.sensors.stackometer";}
}
