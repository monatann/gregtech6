...
public class BuilderLargeSluice {
	...
	public static int[] structure = {
		blockId[1], blockId[1], blockId[1], blockId[1], blockId[1], blockId[1], blockId[1],
		blockId[1], blockId[1], blockId[1], blockId[1], blockId[1], blockId[1], blockId[1],
		blockId[1], blockId[1], blockId[1], blockId[1], blockId[1], blockId[1], blockId[1],

		blockId[0], blockId[0], blockId[0], blockId[0], blockId[0], blockId[0], blockId[0],
		blockId[0], blockId[0], blockId[0], blockId[0], blockId[0], blockId[0], blockId[0],
		blockId[0], blockId[0], blockId[0], blockId[0], blockId[0], blockId[0], blockId[0],

		blockId[0], blockId[0], blockId[0], blockId[0], blockId[0], blockId[0], blockId[0],
		blockId[0], blockId[0], blockId[0], blockId[0], blockId[0], blockId[0], blockId[0],
		blockId[0], blockId[0], blockId[0], blockId[2], blockId[0], blockId[0], blockId[0]
	};
