...
import gregtech6.tileentity.multiblocks.templete.MultiblockFusion;
...
public class MultiTileEntityFusionReactor extends TileEntityBase10MultiBlockMachine {
	...
	public boolean checkStructure2() {
		...
		int[] inOutOption = {MultiTileEntityMultiBlockPart.NOTHING, MultiTileEntityMultiBlockPart.ONLY_ITEM_FLUID, MultiTileEntityMultiBlockPart.ONLY_ENERGY_OUT, MultiTileEntityMultiBlockPart.ONLY_ENERGY_IN};

		return MultiblockFusion.checkStructure(mStructureOkay, this, worldObj, tX, tY, tZ, mFacing, mActive, BuilderFusionReactor.blockId, getMultiTileEntityRegistryID(), inOutOption);
	...
	*/
	...
	static {
		LH.add("gt6.tooltip.multiblock.fusionreactor.1", "For Construction Instructions read the Manual or the GUI.");
		LH.add("gt6.tooltip.multiblock.fusionreactor.2", "144 Iridium Coils, 576 Regular Tungstensteel Walls, 50 Ventilation Units.");
		LH.add("gt6.tooltip.multiblock.fusionreactor.3", "36 Regular Stainless Steel Walls, 53 Galvanized Steel Walls.");
		LH.add("gt6.tooltip.multiblock.fusionreactor.4", "3 Versatile, 12 Logic and 12 Control Quadcore Processing Units.");
		LH.add("gt6.tooltip.multiblock.fusionreactor.5", "Energy Output at the Electric Interfaces");
		LH.add("gt6.tooltip.multiblock.fusionreactor.6", "Laser Input at the 'Glass' Ring");
		LH.add("gt6.tooltip.multiblock.fusionreactor.7", "Items and Fluids are handeled at the normal Walls");
	}
	
	@Override
	public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
		aList.add(Chat.CYAN  + LH.get(LH.STRUCTURE) + ":");
		aList.add(Chat.WHITE + LH.get("gt6.tooltip.multiblock.fusionreactor.1"));
		aList.add(Chat.WHITE + LH.get("gt6.tooltip.multiblock.fusionreactor.2"));
		aList.add(Chat.WHITE + LH.get("gt6.tooltip.multiblock.fusionreactor.3"));
		aList.add(Chat.WHITE + LH.get("gt6.tooltip.multiblock.fusionreactor.4"));
		aList.add(Chat.WHITE + LH.get("gt6.tooltip.multiblock.fusionreactor.5"));
		aList.add(Chat.WHITE + LH.get("gt6.tooltip.multiblock.fusionreactor.6"));
		aList.add(Chat.WHITE + LH.get("gt6.tooltip.multiblock.fusionreactor.7"));
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.multiblock.fusionreactor";}
}
