...
import gregapi6.block.multitileentity.IMultiTileEntity.IMTE_RemovedByPlayer;
...
import gregtech6.tileentity.multiblocks.templete.Multiblock3_4_3_Generate;
...
public class MultiTileEntityLargeBoiler extends TileEntityBase10MultiBlockBase implements ITileEntityEnergy, ITileEntityGibbl, ITileEntityEnergyDataCapacitor, IMultiBlockEnergy, IMultiBlockFluidHandler, IFluidHandler, IMTE_RemovedByPlayer {
	...
	public boolean checkStructure2() {
		...
		int[] blockId = {18101, mBoilerWalls};
		int[] inOutOption = {MultiTileEntityMultiBlockPart.ONLY_ENERGY_IN, MultiTileEntityMultiBlockPart.ONLY_FLUID_IN, MultiTileEntityMultiBlockPart.ONLY_FLUID_OUT};
		return Multiblock3_4_3_Generate.checkStructure(mStructureOkay, this, worldObj, tX, tY, tZ, blockId, getMultiTileEntityRegistryID(), inOutOption);
	...
	static {
		LH.add("gt6.tooltip.multiblock.largeboiler.1", "3x3 Base of Heat Transmitters");
		LH.add("gt6.tooltip.multiblock.largeboiler.2", "3x3x3 Hollow of the Block you crafted this one with");
		LH.add("gt6.tooltip.multiblock.largeboiler.3", "Main centered on Side-Bottom of Boiler facing outwards");
		LH.add("gt6.tooltip.multiblock.largeboiler.4", "Input only possible at Bottom Layer of Boiler");
	}
	
	@Override
	public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
		aList.add(Chat.CYAN     + LH.get(LH.STRUCTURE) + ":");
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.largeboiler.1"));
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.largeboiler.2"));
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.largeboiler.3"));
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.largeboiler.4"));
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.multiblock.boiler.steam";}
}
