...
public class MultiTileEntityShredder extends TileEntityBase10MultiBlockMachine {
	...
	static {
		LH.add("gt6.tooltip.multiblock.shredder.1", "5x5x3 'Basin' of 56 Tungstensteel Walls");
		LH.add("gt6.tooltip.multiblock.shredder.2", "3x3x2 Filling with Shredder Blades");
		LH.add("gt6.tooltip.multiblock.shredder.3", "Main Block centered on Side-Bottom and facing outwards");
		LH.add("gt6.tooltip.multiblock.shredder.4", "Input only at Shredder Blades, Output at Bottom Layer");
	}

	@Override
	public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
		aList.add(Chat.CYAN     + LH.get(LH.STRUCTURE) + ":");
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.shredder.1"));
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.shredder.2"));
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.shredder.3"));
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.shredder.4"));
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.multiblock.shredder";}
}
