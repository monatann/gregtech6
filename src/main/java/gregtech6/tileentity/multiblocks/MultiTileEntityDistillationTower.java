...
public class MultiTileEntityDistillationTower extends TileEntityBase10MultiBlockMachine {
	...
	static {
		LH.add("gt6.tooltip.multiblock.distillationtower.1", "3x3 Base of Heat Transmitters");
		LH.add("gt6.tooltip.multiblock.distillationtower.2", "3x3x8 of Distillation Tower Parts");
		LH.add("gt6.tooltip.multiblock.distillationtower.3", "Main centered on Side-Bottom of Tower facing outwards");
		LH.add("gt6.tooltip.multiblock.distillationtower.4", "Outputs automatically to the Holes on the Backside");
		LH.add("gt6.tooltip.multiblock.distillationtower.5", "Bottom Hole is for outputting all Items");
		LH.add("gt6.tooltip.multiblock.distillationtower.6", "Input only possible at Bottom Layer of Tower");
	}

	@Override
	public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
		aList.add(Chat.CYAN     + LH.get(LH.STRUCTURE) + ":");
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.distillationtower.1"));
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.distillationtower.2"));
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.distillationtower.3"));
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.distillationtower.4"));
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.distillationtower.5"));
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.distillationtower.6"));
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.multiblock.distillationtower";}
}
