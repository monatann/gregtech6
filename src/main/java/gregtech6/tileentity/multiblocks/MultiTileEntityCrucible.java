...
import gregapi6.tileentity.multiblocks.IMultiBlockInventory;
...
import gregtech6.tileentity.multiblocks.templete.Multiblock3_3_3_Crucible;
...
public class MultiTileEntityCrucible extends TileEntityBase10MultiBlockBase implements ITileEntityCrucible, ITileEntityEnergy, ITileEntityWeight, ITileEntityTemperature, ITileEntityMold, ITileEntityServerTickPost, ITileEntityEnergyDataCapacitor, IMultiBlockEnergy, IMultiBlockInventory, IMultiBlockFluidHandler, IFluidHandler {
	...
	public boolean checkStructure2() {
		return Multiblock3_3_3_Crucible.checkStructure(this, worldObj, xCoord, yCoord, zCoord, mWalls, getMultiTileEntityRegistryID());
	...
	static {
		LH.add("gt6.tooltip.multiblock.crucible.1", "3x3x3 Hollow of Walls with opening on Top.");
		LH.add("gt6.tooltip.multiblock.crucible.2", "Main at Bottom-Center.");
		LH.add("gt6.tooltip.multiblock.crucible.3", "Energy IN from Bottom Layer, Stuff IN from Top Layer.");
		LH.add("gt6.tooltip.multiblock.crucible.4", "Molds usable at second Layer of Walls");
		LH.add("gt6.tooltip.multiblock.crucible.5", "KU at Bottom Layer will turn into Air for Steelmaking");
	}

	@Override
	public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
		aList.add(Chat.CYAN     + LH.get(LH.STRUCTURE) + ":");
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.crucible.1"));
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.crucible.2"));
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.crucible.3"));
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.crucible.4"));
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.crucible.5"));
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.multiblock.crucible";}
}
