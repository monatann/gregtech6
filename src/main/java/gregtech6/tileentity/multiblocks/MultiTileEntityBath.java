...
public class MultiTileEntityBath extends TileEntityBase10MultiBlockMachine {
	...
	static {
		LH.add("gt6.tooltip.multiblock.bath.1", "5x5x2 of Stainless Steel Walls");
		LH.add("gt6.tooltip.multiblock.bath.2", "Main Block centered on Side-Bottom and facing outwards");
		LH.add("gt6.tooltip.multiblock.bath.3", "Input and Output at any Blocks");
	}

	@Override
	public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
		aList.add(Chat.CYAN     + LH.get(LH.STRUCTURE) + ":");
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.bath.1"));
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.bath.2"));
		aList.add(Chat.WHITE    + LH.get("gt6.tooltip.multiblock.bath.3"));
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.multiblock.bath";}
}
