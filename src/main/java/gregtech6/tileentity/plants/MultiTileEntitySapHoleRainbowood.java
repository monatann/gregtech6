...
public class MultiTileEntitySapHoleRainbowood extends MultiTileEntityTreeHole {
	...
	private boolean checkLeaves(int aX, int aY, int aZ) {return getBlock(aX, aY, aZ) == BlocksGT.Leaves && getMetaData(aX, aY, aZ) == 15;}
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.tree.rainbowood.saphole";}
}
