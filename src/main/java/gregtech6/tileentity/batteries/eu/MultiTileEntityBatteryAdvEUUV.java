 ...
 */
public class MultiTileEntityBatteryAdvEUUV extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/524288/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/524288/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/524288/sides"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/524288/bar"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.eu.adv.524288";}
}
