 ...
 */
public class MultiTileEntityBatteryEUPUV1 extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/2097152/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/2097152/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/2097152/sides"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/2097152/bar"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.eu.2097152";}
}
