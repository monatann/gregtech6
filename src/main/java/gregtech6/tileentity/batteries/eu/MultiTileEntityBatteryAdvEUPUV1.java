 ...
 */
public class MultiTileEntityBatteryAdvEUPUV1 extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/2097152/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/2097152/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/2097152/sides"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/2097152/bar"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.eu.adv.2097152";}
}
