 ...
 */
public class MultiTileEntityBatteryEU8 extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/8/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/8/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/8/sides"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/8/bar"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.eu.8";}
}
