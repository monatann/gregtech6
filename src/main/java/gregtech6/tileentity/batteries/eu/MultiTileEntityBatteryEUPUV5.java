 ...
 */
public class MultiTileEntityBatteryEUPUV5 extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/536870912/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/536870912/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/536870912/sides"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/536870912/bar"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.eu.536870912";}
}
