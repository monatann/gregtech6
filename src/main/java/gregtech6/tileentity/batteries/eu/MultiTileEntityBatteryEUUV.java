 ...
 */
public class MultiTileEntityBatteryEUUV extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/524288/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/524288/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/524288/sides"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/524288/bar"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.eu.524288";}
}
