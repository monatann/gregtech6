 ...
 */
public class MultiTileEntityBatteryEULuV extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/32768/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/32768/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/32768/sides"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/32768/bar"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.eu.32768";}
}
