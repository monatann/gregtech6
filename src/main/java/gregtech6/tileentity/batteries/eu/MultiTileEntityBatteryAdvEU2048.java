 ...
 */
public class MultiTileEntityBatteryAdvEU2048 extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/2048/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/2048/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/2048/sides"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/2048/bar"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.eu.adv.2048";}
}
