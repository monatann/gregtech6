 ...
 */
public class MultiTileEntityBatteryAdvEU128 extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/128/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/128/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/128/sides"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/128/bar"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.eu.adv.128";}
}
