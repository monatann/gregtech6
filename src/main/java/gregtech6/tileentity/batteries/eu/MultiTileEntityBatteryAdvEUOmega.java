 ...
 */
public class MultiTileEntityBatteryAdvEUOmega extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/2147483648/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/2147483648/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/2147483648/sides"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/2147483648/bar"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.eu.adv.2147483648";}
}
