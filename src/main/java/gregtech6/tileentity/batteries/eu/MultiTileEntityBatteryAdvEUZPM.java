 ...
 */
public class MultiTileEntityBatteryAdvEUZPM extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/131072/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/131072/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/131072/sides"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/131072/bar"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.eu.adv.131072";}
}
