 ...
 */
public class MultiTileEntityBatteryEUPUV3 extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/33554432/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/33554432/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/33554432/sides"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/33554432/bar"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.eu.33554432";}
}
