 ...
 */
public class MultiTileEntityBatteryAdvEUPUV3 extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/33554432/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/33554432/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/33554432/sides"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/advanced/33554432/bar"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.eu.adv.33554432";}
}
