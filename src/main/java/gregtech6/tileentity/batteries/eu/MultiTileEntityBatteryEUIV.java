 ...
 */
public class MultiTileEntityBatteryEUIV extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/8192/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/8192/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/8192/sides"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/8192/bar"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.eu.8192";}
}
