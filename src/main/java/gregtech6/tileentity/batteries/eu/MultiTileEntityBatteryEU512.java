 ...
 */
public class MultiTileEntityBatteryEU512 extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/512/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/512/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/512/sides"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/eu/standard/512/bar"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.eu.512";}
}
