 ...
 */
public class MultiTileEntityBatteryLUPUV5 extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/536870912/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/536870912/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/536870912/sides"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.lu.536870912";}
}
