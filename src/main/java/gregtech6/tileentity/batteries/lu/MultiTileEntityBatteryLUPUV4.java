 ...
 */
public class MultiTileEntityBatteryLUPUV4 extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/134217728/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/134217728/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/134217728/sides"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.lu.134217728";}
}
