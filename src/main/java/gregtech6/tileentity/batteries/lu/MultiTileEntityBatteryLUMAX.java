 ...
 */
public class MultiTileEntityBatteryLUMAX extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/8589934592/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/8589934592/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/8589934592/sides"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.lu.8589934592";}
}
