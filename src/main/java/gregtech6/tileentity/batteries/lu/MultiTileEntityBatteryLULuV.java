 ...
 */
public class MultiTileEntityBatteryLULuV extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/32768/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/32768/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/32768/sides"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.lu.32768";}
}
