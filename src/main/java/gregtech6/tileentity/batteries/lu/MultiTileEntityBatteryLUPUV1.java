 ...
 */
public class MultiTileEntityBatteryLUPUV1 extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/2097152/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/2097152/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/2097152/sides"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.lu.2097152";}
}
