 ...
 */
public class MultiTileEntityBatteryLUPUV2 extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/8388608/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/8388608/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/8388608/sides"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.lu.8388608";}
}
