 ...
 */
public class MultiTileEntityBatteryLUZPM extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/131072/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/131072/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/131072/sides"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.lu.131072";}
}
