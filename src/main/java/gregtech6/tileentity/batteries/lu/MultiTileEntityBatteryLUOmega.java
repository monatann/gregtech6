 ...
 */
public class MultiTileEntityBatteryLUOmega extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/2147483648/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/2147483648/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/2147483648/sides"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.lu.2147483648";}
}
