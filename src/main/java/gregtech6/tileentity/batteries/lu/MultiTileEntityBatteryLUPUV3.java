 ...
 */
public class MultiTileEntityBatteryLUPUV3 extends TileEntityBase08Battery {
	@Override
	...
	public static IIconContainer sTextures[] = new IIconContainer[] {
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/33554432/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/33554432/top"),
		new Textures.BlockIcons.CustomIcon("machines/batteries/lu/33554432/sides"),
	};
	...
	@Override public String getTileEntityName() {return "gt6.multitileentity.battery.lu.33554432";}
}
