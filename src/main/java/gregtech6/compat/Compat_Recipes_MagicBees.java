...
//      RM.Centrifuge   .addRecipe1(T, 16,   64, new long[] {10000, 10000}                  , ST.make(MD.FRMB, "comb", 1, 7), NF, NF);
		...
		RM.Centrifuge   .addRecipe1(T, 16,   64, new long[] {10000,  6000}                  , ST.make(MD.FRMB, "comb", 1,12), NF, NF, OM.dust(MT.WaxMagic), OM.dust(MT.Blaze));
		...
		RM.Centrifuge   .addRecipe1(T, 16,   64, new long[] {10000,  3000,  3000}           , ST.make(MD.FRMB, "comb", 1,14), NF, NF, OM.dust(MT.WaxMagic), IL.Clay_Ball_Brown.get(1), ST.make(Items.clay_ball, 1, 0));
		...
		RM.Centrifuge   .addRecipe1(T, 16,   64, new long[] {10000,  8000,  6000}           , ST.make(MD.FRMB, "comb", 1,16), NF, NF, OM.dust(MT.WaxMagic), IL.FRMB_Propolis_Burning.get(1), OM.dust(MT.Blaze));
		...
		RM.Centrifuge   .addRecipe1(T, 16,   64, new long[] {10000,  8000,  3000,  3000}    , ST.make(MD.FRMB, "comb", 1,18), NF, NF, OM.dust(MT.WaxMagic), IL.FRMB_Propolis_Stony.get(1), IL.Clay_Ball_Brown.get(1), ST.make(Items.clay_ball, 1, 0));
