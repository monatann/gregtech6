...
public class Loader_Recipes_Other implements Runnable {
	@Override public void run() {
		...
		addListener(DYE_OREDICTS_LENS[DYE_INDEX_Red], new IOreDictListenerEvent() {@Override public void onOreRegistration(OreDictRegistrationContainer aEvent) {
			...
			RM.LaserEngraver    .addRecipeX(T, V[0],   DT[4], ST.array(foil.mat(MT.DATA.Wire_T[0]                 , 64), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_ULV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[1],   DT[4], ST.array(foil.mat(MT.DATA.Wire_T[1]                 , 64), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_LV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[2],   DT[4], ST.array(foil.mat(MT.DATA.Wire_T[2]                 , 64), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_MV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[3],   DT[4], ST.array(foil.mat(MT.DATA.Wire_T[3]                 , 64), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_HV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[4],   DT[4], ST.array(foil.mat(MT.DATA.Wire_T[4]                 , 64), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_EV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[5],   DT[4], ST.array(foil.mat(MT.DATA.Wire_T[5]                 , 64), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_IV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[6],   DT[4], ST.array(foil.mat(MT.DATA.Wire_T[6]                 , 64), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_LuV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[7],   DT[4], ST.array(foil.mat(MT.DATA.Wire_T[7]                 , 64), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_ZPM.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[8],   DT[4], ST.array(foil.mat(MT.DATA.Wire_T[8]                 , 64), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_UV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[9],   DT[4], ST.array(foil.mat(MT.DATA.Wire_T[9]                 , 64), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_PUV1.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[10],   DT[4], ST.array(foil.mat(MT.DATA.Wire_T[10]                 , 64), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_PUV2.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[11],   DT[4], ST.array(foil.mat(MT.DATA.Wire_T[11]                 , 64), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_PUV3.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[12],   DT[4], ST.array(foil.mat(MT.DATA.Wire_T[12]                 , 64), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_PUV4.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[13],   DT[4], ST.array(foil.mat(MT.DATA.Wire_T[13]                 , 64), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_PUV5.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[14],   DT[4], ST.array(foil.mat(MT.DATA.Wire_T[14]                 , 64), circuit,  ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_Omega.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[15],   DT[4], ST.array(foil.mat(MT.DATA.Wire_T[15]                 , 64), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_MAX.get(1));
			circuit.setItemDamage(2);
			RM.LaserEngraver    .addRecipeX(T, V[2],   DT[3], ST.array(foil.mat(MT.DATA.Wire_T[0]                 , 32), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_ULV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[3],   DT[3], ST.array(foil.mat(MT.DATA.Wire_T[1]                 , 32), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_LV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[4],   DT[3], ST.array(foil.mat(MT.DATA.Wire_T[2]                 , 32), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_MV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[5],   DT[3], ST.array(foil.mat(MT.DATA.Wire_T[3]                 , 32), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_HV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[6],   DT[3], ST.array(foil.mat(MT.DATA.Wire_T[4]                 , 32), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_EV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[7],   DT[3], ST.array(foil.mat(MT.DATA.Wire_T[5]                 , 32), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_IV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[8],   DT[3], ST.array(foil.mat(MT.DATA.Wire_T[6]                 , 32), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_LuV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[9],   DT[3], ST.array(foil.mat(MT.DATA.Wire_T[7]                 , 32), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_ZPM.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[10],   DT[3], ST.array(foil.mat(MT.DATA.Wire_T[8]                 , 32), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_UV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[11],   DT[3], ST.array(foil.mat(MT.DATA.Wire_T[9]                 , 32), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_PUV1.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[12],   DT[3], ST.array(foil.mat(MT.DATA.Wire_T[10]                 , 32), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_PUV2.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[13],   DT[3], ST.array(foil.mat(MT.DATA.Wire_T[11]                 , 32), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_PUV3.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[14],   DT[3], ST.array(foil.mat(MT.DATA.Wire_T[12]                 , 32), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_PUV4.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[15],   DT[3], ST.array(foil.mat(MT.DATA.Wire_T[13]                 , 32), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_PUV5.get(1));
			circuit.setItemDamage(3);
			RM.LaserEngraver    .addRecipeX(T, V[4],   DT[2], ST.array(foil.mat(MT.DATA.Wire_T[0]                 , 16), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_ULV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[5],   DT[2], ST.array(foil.mat(MT.DATA.Wire_T[1]                 , 16), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_LV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[6],   DT[2], ST.array(foil.mat(MT.DATA.Wire_T[2]                 , 16), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_MV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[7],   DT[2], ST.array(foil.mat(MT.DATA.Wire_T[3]                 , 16), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_HV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[8],   DT[2], ST.array(foil.mat(MT.DATA.Wire_T[4]                 , 16), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_EV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[9],   DT[2], ST.array(foil.mat(MT.DATA.Wire_T[5]                 , 16), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_IV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[10],   DT[2], ST.array(foil.mat(MT.DATA.Wire_T[6]                 , 16), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_LuV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[11],   DT[2], ST.array(foil.mat(MT.DATA.Wire_T[7]                 , 16), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_ZPM.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[12],   DT[2], ST.array(foil.mat(MT.DATA.Wire_T[8]                 , 16), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_UV.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[13],   DT[2], ST.array(foil.mat(MT.DATA.Wire_T[9]                 , 16), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_PUV1.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[14],   DT[2], ST.array(foil.mat(MT.DATA.Wire_T[10]                 , 16), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_PUV2.get(1));
			RM.LaserEngraver    .addRecipeX(T, V[15],   DT[2], ST.array(foil.mat(MT.DATA.Wire_T[11]                 , 16), circuit, ST.amount(0, aEvent.mStack)), IL.Circuit_Wire_PUV3.get(1));

			/*
			RM.LaserEngraver    .addRecipe2(T, 16,   64, foil.mat(tMat                  , 4), ST.amount(0, aEvent.mStack), IL.Circuit_Wire_RedAlloy.get(1));
			RM.LaserEngraver    .addRecipe2(T, 16,   64, foil.mat(MT.Au                 , 4), ST.amount(0, aEvent.mStack), IL.Circuit_Wire_Tin.get(1));
*/
		}});
...
//      RM.Bath             .addRecipe2(T,  0,  128, ST.make(Items.paper, 9, W), ST.tag(9), FL.Glue.make(1000), NF, plateDense.mat(MT.Paper, 1));
		...
		for (FluidStack tFluid : FL.array(MT.He.gas(U, T), MT.Ne.gas(U, T), MT.Ar.gas(U, T), MT.Kr.gas(U, T), MT.Xe.gas(U, T), MT.Rn.gas(U, T))) if (tFluid != null) {
			RM.CrystallisationCrucible.addRecipe1(T, V[3],  DT[16], OM.dust(MT.Si             ,  U9), FL.array(              tFluid    , MT.Si            .liquid(35*U9, T)), NF, bouleGt.mat(MT.Si              , 1));
			RM.CrystallisationCrucible.addRecipe1(T, V[3],  DT[16], OM.dust(MT.Ge             ,  U9), FL.array(              tFluid    , MT.Ge            .liquid(35*U9, T)), NF, bouleGt.mat(MT.Ge              , 1));
			RM.CrystallisationCrucible.addRecipe1(T, V[3],  DT[16], OM.dust(MT.RedstoneAlloy  ,  U9), FL.array(              tFluid    , MT.RedstoneAlloy .liquid(35*U9, T)), NF, bouleGt.mat(MT.RedstoneAlloy   , 1));
			RM.CrystallisationCrucible.addRecipe1(T, V[3],  DT[16], OM.dust(MT.NikolineAlloy  ,  U9), FL.array(              tFluid    , MT.NikolineAlloy .liquid(35*U9, T)), NF, bouleGt.mat(MT.NikolineAlloy   , 1));
			RM.CrystallisationCrucible.addRecipe1(T, V[3],  DT[16], OM.dust(MT.TeslatineAlloy ,  U9), FL.array(              tFluid    , MT.TeslatineAlloy.liquid(35*U9, T)), NF, bouleGt.mat(MT.TeslatineAlloy  , 1));
			RM.CrystallisationCrucible.addRecipe1(T, V[3], DT[16]*9, OM.dust(MT.Si                  ), FL.array(FL.mul(tFluid, 9), MT.Si            .liquid(35*U , T)), NF, bouleGt.mat(MT.Si              , 9));
			RM.CrystallisationCrucible.addRecipe1(T, V[3], DT[16]*9, OM.dust(MT.Ge                  ), FL.array(FL.mul(tFluid, 9), MT.Ge            .liquid(35*U , T)), NF, bouleGt.mat(MT.Ge              , 9));
			RM.CrystallisationCrucible.addRecipe1(T, V[3], DT[16]*9, OM.dust(MT.RedstoneAlloy       ), FL.array(FL.mul(tFluid, 9), MT.RedstoneAlloy .liquid(35*U , T)), NF, bouleGt.mat(MT.RedstoneAlloy   , 9));
			RM.CrystallisationCrucible.addRecipe1(T, V[3], DT[16]*9, OM.dust(MT.NikolineAlloy       ), FL.array(FL.mul(tFluid, 9), MT.NikolineAlloy .liquid(35*U , T)), NF, bouleGt.mat(MT.NikolineAlloy   , 9));
			RM.CrystallisationCrucible.addRecipe1(T, V[3], DT[16]*9, OM.dust(MT.TeslatineAlloy      ), FL.array(FL.mul(tFluid, 9), MT.TeslatineAlloy.liquid(35*U , T)), NF, bouleGt.mat(MT.TeslatineAlloy  , 9));

			RM.CrystallisationCrucible.addRecipe1(T,V[3],  DT[16], OM.dust(MT.Al2O3          ,  U3), FL.array(              tFluid    , MT.Al2O3         .liquid(29*U3, T)), NF, bouleGt.mat(MT.Sapphire        , 1));
			RM.CrystallisationCrucible.addRecipe1(T,V[3],  DT[16], OM.dust(MT.Mg             ,2*U3), FL.array(              tFluid    , MT.Al2O3         .liquid(10*U3, T)), NF, bouleGt.mat(MT.GreenSapphire   , 1));
			RM.CrystallisationCrucible.addRecipe1(T,V[3],  DT[16], OM.dust(MT.Ti             ,2*U3), FL.array(              tFluid    , MT.Al2O3         .liquid(10*U3, T)), NF, bouleGt.mat(MT.YellowSapphire  , 1));
			RM.CrystallisationCrucible.addRecipe1(T,V[3],  DT[16], OM.dust(MT.Cu             ,2*U3), FL.array(              tFluid    , MT.Al2O3         .liquid(10*U3, T)), NF, bouleGt.mat(MT.OrangeSapphire  , 1));
			RM.CrystallisationCrucible.addRecipe1(T,V[3],  DT[16], OM.dust(MT.Fe             ,2*U3), FL.array(              tFluid    , MT.Al2O3         .liquid(10*U3, T)), NF, bouleGt.mat(MT.BlueSapphire    , 1));
			RM.CrystallisationCrucible.addRecipe1(T,V[3],  DT[16], OM.dust(MT.V              ,2*U3), FL.array(              tFluid    , MT.Al2O3         .liquid(10*U3, T)), NF, bouleGt.mat(MT.PurpleSapphire  , 1));
			RM.CrystallisationCrucible.addRecipe1(T,V[3],  DT[16], OM.dust(MT.Cr             ,2*U3), FL.array(              tFluid    , MT.Al2O3         .liquid(10*U3, T)), NF, bouleGt.mat(MT.Ruby            , 1));
			RM.CrystallisationCrucible.addRecipe1(T,V[3],  DT[16]*3, OM.dust(MT.Al2O3          ,  U ), FL.array(FL.mul(tFluid, 3), MT.Al2O3         .liquid(29*U , T)), NF, bouleGt.mat(MT.Sapphire        , 3));
			RM.CrystallisationCrucible.addRecipe1(T,V[3],  DT[16]*3, OM.dust(MT.Mg             ,2*U ), FL.array(FL.mul(tFluid, 3), MT.Al2O3         .liquid(10*U , T)), NF, bouleGt.mat(MT.GreenSapphire   , 3));
			RM.CrystallisationCrucible.addRecipe1(T,V[3],  DT[16]*3, OM.dust(MT.Ti             ,2*U ), FL.array(FL.mul(tFluid, 3), MT.Al2O3         .liquid(10*U , T)), NF, bouleGt.mat(MT.YellowSapphire  , 3));
			RM.CrystallisationCrucible.addRecipe1(T,V[3],  DT[16]*3, OM.dust(MT.Cu             ,2*U ), FL.array(FL.mul(tFluid, 3), MT.Al2O3         .liquid(10*U , T)), NF, bouleGt.mat(MT.OrangeSapphire  , 3));
			RM.CrystallisationCrucible.addRecipe1(T,V[3],  DT[16]*3, OM.dust(MT.Fe             ,2*U ), FL.array(FL.mul(tFluid, 3), MT.Al2O3         .liquid(10*U , T)), NF, bouleGt.mat(MT.BlueSapphire    , 3));
			RM.CrystallisationCrucible.addRecipe1(T,V[3],  DT[16]*3, OM.dust(MT.V              ,2*U ), FL.array(FL.mul(tFluid, 3), MT.Al2O3         .liquid(10*U , T)), NF, bouleGt.mat(MT.PurpleSapphire  , 3));
			RM.CrystallisationCrucible.addRecipe1(T,V[3],  DT[16]*3, OM.dust(MT.Cr             ,2*U ), FL.array(FL.mul(tFluid, 3), MT.Al2O3         .liquid(10*U , T)), NF, bouleGt.mat(MT.Ruby            , 3));
		}
