...
import gregtech6.worldgen.ChestGenHooksChestReplacer;
...
public class Loader_Loot implements Runnable {
	...
	public void run() {
		...
		addLoot(ChestGenHooks.BONUS_CHEST               ,   1, 2, 8, ST.make(BlocksGT.Sapling, 1, 0));
		addLoot(ChestGenHooks.BONUS_CHEST               ,   1, 2, 8, ST.make(BlocksGT.Sapling, 1, 1));
		addLoot(ChestGenHooks.BONUS_CHEST               ,   1, 2, 8, ST.make(BlocksGT.Sapling, 1, 2));
		addLoot(ChestGenHooks.BONUS_CHEST               ,   1, 2, 8, ST.make(BlocksGT.Sapling, 1, 3));
		addLoot(ChestGenHooks.BONUS_CHEST               ,   1, 2, 8, ST.make(BlocksGT.Sapling, 1, 4));
		addLoot(ChestGenHooks.BONUS_CHEST               ,   1, 2, 8, ST.make(BlocksGT.Sapling, 1, 5));
		addLoot(ChestGenHooks.BONUS_CHEST               ,   1, 2, 8, ST.make(BlocksGT.Sapling, 1, 6));
...
//      addLoot(ChestGenHooks.DUNGEON_CHEST             ,  20, 1, 1, ItemList.Spray_Pepper.get(1));
		...
		addLoot(ChestGenHooks.DUNGEON_CHEST             ,   8, 1, 6, OP.gemFlawless.mat(MT.Ruby, 1));
		...
		addLoot(ChestGenHooks.DUNGEON_CHEST             ,  10, 2, 8, ST.make(BlocksGT.Sapling, 1, 0));
		addLoot(ChestGenHooks.DUNGEON_CHEST             ,  10, 2, 8, ST.make(BlocksGT.Sapling, 1, 1));
		addLoot(ChestGenHooks.DUNGEON_CHEST             ,  10, 2, 8, ST.make(BlocksGT.Sapling, 1, 2));
		addLoot(ChestGenHooks.DUNGEON_CHEST             ,  10, 2, 8, ST.make(BlocksGT.Sapling, 1, 3));
		addLoot(ChestGenHooks.DUNGEON_CHEST             ,  10, 2, 8, ST.make(BlocksGT.Sapling, 1, 4));
		...
		addLoot(ChestGenHooks.PYRAMID_DESERT_CHEST      ,   2, 2, 8, OP.gemFlawless.mat(MT.Olivine, 1));
		addLoot(ChestGenHooks.PYRAMID_DESERT_CHEST      ,   4, 2, 8, OP.gemFlawless.mat(MT.Pyrope, 1));
		addLoot(ChestGenHooks.PYRAMID_DESERT_CHEST      ,   4, 2, 8, OP.gemFlawless.mat(MT.Grossular, 1));
		...
		addLoot(ChestGenHooks.PYRAMID_JUNGLE_CHEST      ,   2, 2, 8, OP.gemFlawless.mat(MT.Olivine, 1));
		addLoot(ChestGenHooks.PYRAMID_JUNGLE_CHEST      ,   4, 2, 8, OP.gemFlawless.mat(MT.Pyrope, 1));
		addLoot(ChestGenHooks.PYRAMID_JUNGLE_CHEST      ,   4, 2, 8, OP.gemFlawless.mat(MT.Grossular, 1));
		...
		addLoot(ChestGenHooks.PYRAMID_JUNGLE_CHEST      ,   6, 2, 8, ST.make(BlocksGT.Sapling, 1, 3));
		addLoot(ChestGenHooks.PYRAMID_JUNGLE_CHEST      ,   6, 2, 8, ST.make(BlocksGT.Sapling, 1, 5));
		addLoot(ChestGenHooks.PYRAMID_JUNGLE_CHEST      ,   1, 2, 8, ST.make(BlocksGT.Sapling, 1, 7));
...
//      addLoot(ChestGenHooks.MINESHAFT_CORRIDOR        ,  10, 1, 1, ItemList.Spray_Ice.get(1));
		...
		addLoot(ChestGenHooks.MINESHAFT_CORRIDOR        ,   2, 1, 4, OP.gemFlawless.mat(MT.Olivine, 1));
		addLoot(ChestGenHooks.MINESHAFT_CORRIDOR        ,   4, 1, 4, OP.gemFlawless.mat(MT.Spessartine, 1));
		addLoot(ChestGenHooks.MINESHAFT_CORRIDOR        ,   4, 1, 4, OP.gemFlawless.mat(MT.Uvarovite, 1));
