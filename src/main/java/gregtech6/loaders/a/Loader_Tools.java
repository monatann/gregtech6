...
import static gregapi6.data.CS.ToolsGT.*;
...
import gregapi6.data.CS.ArmorsGT;
...
import gregapi6.item.multiitem.MultiItemToolWithCompat;
...
import gregtech6.items.tools.crafting.GT_Tool_BendingCylinder;
...
import gregtech6.items.tools.pocket.GT_Tool_Pocket_Knife;
import gregtech6.items.tools.pocket.GT_Tool_Pocket_Multitool;
import gregtech6.items.tools.pocket.GT_Tool_Pocket_Saw;
import gregtech6.items.tools.pocket.GT_Tool_Pocket_Scissors;
import gregtech6.items.tools.pocket.GT_Tool_Pocket_Screwdriver;
...
public class Loader_Tools implements Runnable {
	...
	public void run() {
		...
		ArmorsGT.HAZMATS_INSECTS    .add(ArmorsGT.HAZMAT_INSECTS    [0] = new ItemArmorBase(MD.GT.mID, "gt6.armor.hazmat.insect.head"     , "Bumblehead"                       , "Full Set protects against any Insects"         , "hazard_insects"   , 0, new int[] {1, 1, 1, 1}, 128, 8, 0, F, T, "RRR", "RGR", "q l", 'R', foil.dat(MT.Rubber), 'G', ST.make(Blocks.stained_glass_pane, 1, 15-DYE_INDEX_Black)));
		...
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.SOFTHAMMER                , "Soft Hammer"                     , ""                                                    , new GT_Tool_SoftHammer()                                       .setMaterialAmount(toolHeadHammer                 .mAmount), OreDictToolNames.softhammer                                                                                                              , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.LIMUS         , 4)                                                                ), TOOL_softhammer);
		...
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.FILE                      , "File"                            , ""                                                    , new GT_Tool_File()                                             .setMaterialAmount(toolHeadFile                   .mAmount), OreDictToolNames.file                                                                                                                    , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.FABRICO       , 2), TC.stack(TC.ORDO          , 2)                                ), TOOL_file);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.CROWBAR                   , "Crowbar"                         , ""                                                    , new GT_Tool_Crowbar()                                          .setMaterialAmount(3*U2                                      ), OreDictToolNames.crowbar                                                                                                                 , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.FABRICO       , 2), TC.stack(TC.TELUM         , 2)                                ), TOOL_crowbar);
		...
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.WIRECUTTER                , "Wire Cutter"                     , ""                                                    , new GT_Tool_WireCutter()                                       .setMaterialAmount(4*U                                       ), OreDictToolNames.wirecutter                                                                                                              , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.FABRICO       , 2), TC.stack(TC.ORDO          , 2)                                ), TOOL_cutter);
...
//      ToolsGT.add(ToolIDs.sMetaTool.addTool(ToolIDs.SICKLE                    , "Sickle"                          , "Harvests Crops more efficiently"                     , new GT_Tool_Sickle()                                           .setMaterialAmount(3*U                                       ), OreDictToolNames.blade                                                                                                                   , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.GRANUM        , 2)                                ), TOOL_sickle);
		...
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.PLUNGER                   , "Plunger"                         , ""                                                    , new GT_Tool_Plunger()                                          .setMaterialAmount(0                                         ), OreDictToolNames.plunger                                                                                                                 , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.VACUOS        , 2), TC.stack(TC.ITER          , 2)                                ), TOOL_plunger);
		...
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.POCKET_FILE               , "Pocket Multitool (File)"         , ""                                                    , new GT_Tool_Pocket_File(ToolsGT.POCKET_SCREWDRIVER)            .setMaterialAmount(199*U18                                   ), OreDictToolNames.file                                                                                                                    , TC.stack(TC.INSTRUMENTUM  , 6), TC.stack(TC.FABRICO       , 3), TC.stack(TC.ORDO          , 3)                                ), TOOL_file);
		...
		CR.shaped(ToolsGT.sMetaTool.getToolWithStats(ToolsGT.ROLLING_PIN        , tMaterial         , tMaterial         ), CR.DEF_MIR   , "  S", " I ", "S k", 'I', plank.dat(tMaterial), 'S', stick.dat(tMaterial));
		}
		...
		*/
		...
		toolHeadChainsaw            .addListener(new OreProcessing_Tool(CHAINSAW_LV             , tCategory + "Chainsaw"                ,F,F,0,0, null                          , null                                                                                      , new String[][] {{"WVW", "XhX", "WVW"}}                        , chain         , null, null, ring.dat(ANY.Steel),plate.dat(ANY.Steel), new And(ANTIMATTER.NOT, typemin(2))));
		toolHeadDrill               .addListener(new OreProcessing_Tool(MININGDRILL_LV          , tCategory + "MiningDrill"             ,F,F,0,0, null                          , null                                                                                      , new String[][] {{"PVP", "PVP", "VhV"}, {"CVC", "CVC", "VhV"}} , null          , null, null, plateCurved.dat(ANY.Steel)        , null, new And(ANTIMATTER.NOT, typemin(2))));
		toolHeadWrench              .addListener(new OreProcessing_Tool(WRENCH                  , tCategory + "Wrench"                  ,F,F,0,0, null                          , new String[][] {{"PhP", "PPP", " P "}, {"CfC", "CCC", " C "}}                             , new String[][] {{"hPW", "PVP", "WPd"}, {"hCW", "CVC", "WCd"}} , null          , null, null, ring.dat(ANY.Steel),screw.dat(ANY.Steel), new And(ANTIMATTER.NOT, typemin(2), qualmin(1))));
		toolHeadWrench              .addListener(new OreProcessing_Tool(MONKEY_WRENCH           , tCategory + "MonkeyWrench"            ,F,F,0,0, null                          , new String[][] {{"PPd", "hPP", "PPT"}, {"CCd", "fCC", "CCT"}}                             , null                                                          , null          , null, null, null                              , null, new And(ANTIMATTER.NOT, typemin(2), qualmin(1))));
		...
		toolHeadPickaxe             .addListener(new OreProcessing_Tool(SCOOP                   , tCategory + "Scoop"                   ,F,F,0,0, null                          , new String[][] {{"SVS", "SSS", "xSh"}}                                                    , null                                                          , null          , null, null, Blocks.wool                       , null, ANTIMATTER.NOT));
		...
		toolHeadSword               .addListener(new OreProcessing_Tool(BUTCHERYKNIFE           , tCategory + "ButcheryKnife"           ,F,F,0,0, null                          , new String[][] {{"fPP", "hPP", "  H"}, {"fCC", " CC", "  H"}}                             , null                                                          , null          , null, null, null                              , null, new And(ANTIMATTER.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(2))));
		...
		toolHeadWrench              .addListener(new OreProcessing_Tool(WRENCH_MV               , tCategory + "WrenchMV"                ,F,T, -1,V[2], MT.DATA.Electric_T[2]    , new String[][] {{"dAT", "XWX", "XVX"}}                                                    , null                                                          , plateCurved.dat(MT.DATA.Electric_T[2]), null, null, tBattery, IL.MOTORS[2], new And(ANTIMATTER.NOT, WOOD.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(3), qualmin(1))));
		toolHeadDrill               .addListener(new OreProcessing_Tool(MININGDRILL_MV          , tCategory + "MiningDrillMV"           ,F,T, -1,V[2], MT.DATA.Electric_T[2]    , new String[][] {{"dAT", "XWX", "XVX"}}                                                    , null                                                          , plateCurved.dat(MT.DATA.Electric_T[2]), null, null, tBattery, IL.MOTORS[2], new And(ANTIMATTER.NOT, WOOD.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(3), qualmin(1))));
		toolHeadChainsaw            .addListener(new OreProcessing_Tool(CHAINSAW_MV             , tCategory + "ChainsawMV"              ,F,T, -1,V[2], MT.DATA.Electric_T[2]    , new String[][] {{"dAT", "XWX", "XVX"}}                                                    , null                                                          , plateCurved.dat(MT.DATA.Electric_T[2]), null, null, tBattery, IL.MOTORS[2], new And(ANTIMATTER.NOT, WOOD.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(3), qualmin(1))));
		}
