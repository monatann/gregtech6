...
CAPTION="$(curl -s https://gregtech6.mechaenetia.com/imagecaption.adoc)"
CAPTION="${CAPTION:1:${#CAPTION}-1}"

# Write the Post
echo 'An Update to GregTech has been released!'
echo "https://gregtech6.mechaenetia.com/1.7.10/"
echo ""
echo 'Cue the fully automatic Changelog:'
echo '![Screenshot](https://gregtech6.mechaenetia.com'"$(curl -s https://gregtech6.mechaenetia.com/gallery/LATEST.image.url))"
echo "$CAPTION"
echo '[quote]'
